...
package Test_Unicode is
   ...
   procedure Test_Locale_LC_All_UTF8_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  FUNC-UNI-003: LC_CTYPE="en_US.UTF-8", LC_ALL absent -> Basic
   procedure Test_Locale_LC_Ctype_UTF8_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  FUNC-UNI-003: LANG="en_US.UTF-8", LC_ALL and LC_CTYPE absent -> Basic
   procedure Test_Locale_Lang_UTF8_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Term_Linux_With_UTF8_Locale_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  FUNC-UNI-004: TERM="linux", GITHUB_ACTIONS present -> Basic (CI overrides)
   procedure Test_Term_Linux_With_CI_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Windows_WT_Session_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  FUNC-UNI-005: OS_TYPE="Windows_NT", TERM_PROGRAM="vscode" -> Basic
   procedure Test_Windows_Term_Program_Vscode_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Windows_JetBrains_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_CI_Overrides_Term_Linux (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Priority_Locale_And_CI_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  FUNC-UNI-008: Locale Basic + TERM=linux -> Basic (floor not reduced)
   procedure Test_Priority_Locale_Floor_Not_Reduced_By_Linux (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  FUNC-UNI-008: CI Basic + TERM=linux -> Basic (floor not reduced)
   procedure Test_Priority_CI_Floor_Not_Reduced_By_Linux (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Edge_All_Signals_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);
