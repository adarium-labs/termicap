...
package body Test_Terminfo is
   ...
   function B (V : Natural) return Byte is (Byte (V));

   --  Encode a 16-bit value as two little-endian bytes: (low, high).
   function LE16_Lo (V : Natural) return Byte is (B (V mod 256));
   function LE16_Hi (V : Natural) return Byte is (B ((V / 256) mod 256));
   ...
   function Make_Legacy_Header
     (Names_Size   : Natural;
      Bool_Count   : Natural;
      Num_Count    : Natural;
      String_Count : Natural;
      Table_Size   : Natural) return Byte_Array
   is
      H : Byte_Array (1 .. 12) :=
        [16#1A#, 16#01#,                                --  Magic: Legacy_16bit
         LE16_Lo (Names_Size),   LE16_Hi (Names_Size),  --  Names_Size
         LE16_Lo (Bool_Count),   LE16_Hi (Bool_Count),  --  Bool_Count
         LE16_Lo (Num_Count),    LE16_Hi (Num_Count),   --  Num_Count
         LE16_Lo (String_Count), LE16_Hi (String_Count), --  String_Count
         LE16_Lo (Table_Size),   LE16_Hi (Table_Size)]; --  Table_Size
   begin
      return H;
   ...
   is
      H : Byte_Array (1 .. 12) :=
        [16#1E#, 16#02#,                                --  Magic: Extended_32bit
         LE16_Lo (Names_Size),   LE16_Hi (Names_Size),
         LE16_Lo (Bool_Count),   LE16_Hi (Bool_Count),
         LE16_Lo (Num_Count),    LE16_Hi (Num_Count),
         LE16_Lo (String_Count), LE16_Hi (String_Count),
         LE16_Lo (Table_Size),   LE16_Hi (Table_Size)];
   begin
      return H;
   ...
   begin
      ...
      Register_Routine
        (T, Test_TIF007_Detect_Legacy_Magic'Access,
         "FUNC-TIF-007: magic 0x011A (LE: 0x1A 0x01) -> Legacy_16bit");
      Register_Routine
        (T, Test_TIF007_Detect_Extended_Magic'Access,
         "FUNC-TIF-007: magic 0x021E (LE: 0x1E 0x02) -> Extended_32bit");
      Register_Routine
        (T, Test_TIF007_Detect_Unknown_Magic'Access,
         "FUNC-TIF-007: magic 0xDEAD -> Unknown");
      Register_Routine
        (T, Test_TIF007_Minimum_Buffer'Access,
         "FUNC-TIF-007: minimum 2-byte buffer is accepted");

      --  FUNC-TIF-008: Parse_Header
      Register_Routine
        (T, Test_TIF008_Valid_Legacy_Header'Access,
         "FUNC-TIF-008: valid legacy header -> Success=True, offsets correct");
      Register_Routine
        (T, Test_TIF008_Names_Size_Exceeds_Max'Access,
         "FUNC-TIF-008: Names_Size > MAX_NAMES_SECTION_SIZE -> Success=False");
      Register_Routine
        (T, Test_TIF008_Total_Size_Exceeds_Buffer'Access,
         "FUNC-TIF-008: total size > buffer size -> Success=False");
      Register_Routine
        (T, Test_TIF008_Alignment_Padding'Access,
         "FUNC-TIF-008: odd (Names_Size+Bool_Count) -> alignment padding applied");

      --  FUNC-TIF-009: Get_Boolean
      Register_Routine
        (T, Test_TIF009_Bool_True_Value'Access,
         "FUNC-TIF-009: bool byte=1 -> True_Value");
      Register_Routine
        (T, Test_TIF009_Bool_False_Value'Access,
         "FUNC-TIF-009: bool byte=0 -> False_Value");
      Register_Routine
        (T, Test_TIF009_Bool_Cancelled'Access,
         "FUNC-TIF-009: bool byte=0xFF -> Cancelled");
      Register_Routine
        (T, Test_TIF009_Bool_Absent_Byte'Access,
         "FUNC-TIF-009: bool byte=0xFE -> Absent");
      Register_Routine
        (T, Test_TIF009_Bool_Out_Of_Range'Access,
         "FUNC-TIF-009: index >= Bool_Count -> Absent");

      --  FUNC-TIF-010: Get_Numeric
      Register_Routine
        (T, Test_TIF010_Colors_256_Legacy'Access,
         "FUNC-TIF-010: COLORS_INDEX=13 value=256 (LE 0x00 0x01) -> 256");
      Register_Routine
        (T, Test_TIF010_Absent_Numeric'Access,
         "FUNC-TIF-010: numeric LE 0xFF 0xFF -> ABSENT_NUMERIC");
      Register_Routine
        (T, Test_TIF010_Cancelled_Numeric'Access,
         "FUNC-TIF-010: numeric LE 0xFE 0xFF -> CANCELLED_NUMERIC");
      Register_Routine
        (T, Test_TIF010_Numeric_Out_Of_Range'Access,
         "FUNC-TIF-010: index >= Num_Count -> ABSENT_NUMERIC");
      Register_Routine
        (T, Test_TIF010_Colors_16M_Extended'Access,
         "FUNC-TIF-010: Extended_32bit colors=16777216 (LE 0x00 0x00 0x00 0x01)");

      --  FUNC-TIF-011: Get_String
      Register_Routine
        (T, Test_TIF011_Setaf_Present'Access,
         "FUNC-TIF-011: setaf at SETAF_INDEX -> Present=True, non-empty");
      Register_Routine
        (T, Test_TIF011_String_Absent'Access,
         "FUNC-TIF-011: string offset=-1 -> Present=False, Length=0");
      Register_Routine
        (T, Test_TIF011_String_Out_Of_Range'Access,
         "FUNC-TIF-011: index >= String_Count -> Present=False, Length=0");
      Register_Routine
        (T, Test_TIF011_String_Truncated'Access,
         "FUNC-TIF-011: string > MAX_CAPABILITY_STRING_LENGTH -> truncated to max");

      --  FUNC-TIF-012: Parse_Extended_Header
      Register_Routine
        (T, Test_TIF012_No_Extended_Section'Access,
         "FUNC-TIF-012: buffer ends at Total_Standard_Size -> Success=False");
      Register_Routine
        (T, Test_TIF012_Valid_Extended_Header'Access,
         "FUNC-TIF-012: valid extended header -> Success=True");

      --  FUNC-TIF-014: Extract_Truecolor_Flags
      Register_Routine
        (T, Test_TIF014_RGB_Flag_True'Access,
         "FUNC-TIF-014: extended boolean RGB=1 -> Has_RGB=True");
      Register_Routine
        (T, Test_TIF014_Tc_Flag_True'Access,
         "FUNC-TIF-014: extended boolean Tc=1 -> Has_Tc=True");
      Register_Routine
        (T, Test_TIF014_No_Truecolor_Flags'Access,
         "FUNC-TIF-014: no RGB or Tc in extended section -> both False");

      --  Parse_Buffer convenience function
      Register_Routine
        (T, Test_Parse_Buffer_Valid_Legacy'Access,
         "Parse_Buffer: valid legacy buffer -> Success=True, snapshot populated");
      Register_Routine
        (T, Test_Parse_Buffer_Wrong_Magic'Access,
         "Parse_Buffer: wrong magic -> Error_Invalid_Magic");
      Register_Routine
        (T, Test_Parse_Buffer_Too_Short'Access,
         "Parse_Buffer: 2-byte buffer with valid magic but no room for header");
   end Register_Tests;
   ...
   begin
      Assert (Result = Legacy_16bit,
              "Detect_Format: LE bytes 0x1A 0x01 should yield Legacy_16bit");
   ...
   is
      ...
      Result : constant Terminfo_Format := Detect_Format (Buffer, 2);
   begin
      Assert (Result = Extended_32bit,
              "Detect_Format: LE bytes 0x1E 0x02 should yield Extended_32bit");
   ...
   begin
      Assert (Result = Unknown,
              "Detect_Format: LE bytes 0xAD 0xDE (0xDEAD) should yield Unknown");
   ...
   begin
      ...
      Assert (Result in Legacy_16bit | Extended_32bit | Unknown,
   ...
   is
      ...
      Hdr    : constant Byte_Array (1 .. 12) :=
        Make_Legacy_Header (Names_Size   => 2,
                            Bool_Count   => 0,
                            Num_Count    => 1,
                            String_Count => 0,
                            Table_Size   => 0);
      ...
      Buffer : constant Byte_Array (1 .. 16) :=
        [Hdr (1), Hdr (2), Hdr (3), Hdr (4), Hdr (5), Hdr (6),
         ...
         16#78#, 16#00#,   --  names: "x\0"
         16#00#, 16#00#];  --  numeric entry: 0
   ...
   begin
      Parse_Header (Buffer  => Buffer,
                    ...
                    Success => Success);
      Assert (Success,
              "Parse_Header: valid legacy header should succeed");
      Assert (Header.Names_Size = 2,
              "Parse_Header: Names_Size should be 2");
      Assert (Header.Bool_Count = 0,
              "Parse_Header: Bool_Count should be 0");
      Assert (Header.Num_Count = 1,
              "Parse_Header: Num_Count should be 1");
      Assert (Header.String_Count = 0,
              "Parse_Header: String_Count should be 0");
      --  Bool_Section_Offset = HEADER_SIZE + Names_Size + 1 = 12 + 2 + 1 = 15
      Assert (Header.Bool_Section_Offset = 15,
              "Parse_Header: Bool_Section_Offset should be 15");
      --  Num_Section_Offset = 15 (no bools, no padding: 2+0=2 even)
      Assert (Header.Num_Section_Offset = 15,
              "Parse_Header: Num_Section_Offset should be 15");
      Assert (Header.Total_Standard_Size = 16,
              "Parse_Header: Total_Standard_Size should be 16");
   ...
   is
      ...
      Buffer : constant Byte_Array (1 .. 12) :=
        [16#1A#, 16#01#,   --  Magic: Legacy_16bit
         16#01#, 16#02#,   --  Names_Size = 513 (LE: 0x01, 0x02)
         16#00#, 16#00#,   --  Bool_Count = 0
         16#00#, 16#00#,   --  Num_Count = 0
         16#00#, 16#00#,   --  String_Count = 0
         16#00#, 16#00#];  --  Table_Size = 0
      Header  : Parsed_Header;
      Success : Boolean;
   begin
      Parse_Header (Buffer  => Buffer,
                    ...
                    Success => Success);
      Assert (not Success,
              "Parse_Header: Names_Size=513 > MAX_NAMES_SECTION_SIZE=512 should fail");
   ...
   is
      ...
      Buffer : constant Byte_Array (1 .. 14) :=
        [16#1A#, 16#01#,   --  Magic: Legacy_16bit
         16#01#, 16#00#,   --  Names_Size = 1
         16#00#, 16#00#,   --  Bool_Count = 0
         16#64#, 16#00#,   --  Num_Count = 100 (LE: 0x64, 0x00)
         16#00#, 16#00#,   --  String_Count = 0
         16#00#, 16#00#,   --  Table_Size = 0
   ...
   begin
      Parse_Header (Buffer  => Buffer,
                    ...
                    Success => Success);
      Assert (not Success,
              "Parse_Header: total computed size > buffer size should fail");
   ...
   is
      ...
      Buffer : constant Byte_Array (1 .. 20) :=
        [16#1A#, 16#01#,   --  Magic: Legacy_16bit
         16#03#, 16#00#,   --  Names_Size = 3
         16#02#, 16#00#,   --  Bool_Count = 2
         16#01#, 16#00#,   --  Num_Count = 1
         16#00#, 16#00#,   --  String_Count = 0
         16#00#, 16#00#,   --  Table_Size = 0
         16#76#, 16#74#, 16#00#,  --  names: "vt\0"
         16#01#, 16#00#,   --  bool[0]=1 (True_Value), bool[1]=0 (False_Value)
         16#00#,           --  alignment padding
         16#08#, 16#00#];  --  numeric[0] = 8 (LE)
      Header  : Parsed_Header;
      Success : Boolean;
   begin
      Parse_Header (Buffer  => Buffer,
                    ...
                    Success => Success);
      Assert (Success,
              "Parse_Header: odd names+bools (3+2=5) with alignment padding should succeed");
      Assert (Header.Names_Size = 3,
              "Parse_Header (padding): Names_Size should be 3");
      Assert (Header.Bool_Count = 2,
              "Parse_Header (padding): Bool_Count should be 2");
      --  Bool_Section_Offset = 12 + 3 + 1 = 16
      Assert (Header.Bool_Section_Offset = 16,
              "Parse_Header (padding): Bool_Section_Offset should be 16");
      --  Num_Section_Offset = 16 + 2 + 1 (pad) = 19
      Assert (Header.Num_Section_Offset = 19,
              "Parse_Header (padding): Num_Section_Offset should be 19 (after pad)");
      Assert (Header.Total_Standard_Size = 20,
              "Parse_Header (padding): Total_Standard_Size should be 20");
   ...
   function Make_Bool_Num_Buffer
     (Bool_0 : Byte; Bool_1 : Byte; Bool_2 : Byte; Bool_3 : Byte;
      Num_0  : Integer; Num_1  : Integer; Num_2  : Integer; Num_3  : Integer)
      return Byte_Array
   is
      --  Encode a signed integer as two LE bytes (handle negative via mod).
      function Enc_Lo (V : Integer) return Byte is
        (B (V mod 256 + (if V < 0 then 256 else 0)));
      function Enc_Hi (V : Integer) return Byte is
        (B ((V / 256 + (if V < -127 then 256 else 0)) mod 256));

      Buf : Byte_Array (1 .. 26) :=
        [16#1A#, 16#01#,  --  Magic: Legacy_16bit
         16#02#, 16#00#,  --  Names_Size = 2
         16#04#, 16#00#,  --  Bool_Count = 4
         16#04#, 16#00#,  --  Num_Count = 4
         16#00#, 16#00#,  --  String_Count = 0
         16#00#, 16#00#,  --  Table_Size = 0
         16#74#, 16#00#,  --  names: "t\0"
         Bool_0, Bool_1, Bool_2, Bool_3,  --  boolean section (4 bytes)
         Enc_Lo (Num_0), Enc_Hi (Num_0),  --  numeric[0]
         Enc_Lo (Num_1), Enc_Hi (Num_1),  --  numeric[1]
         Enc_Lo (Num_2), Enc_Hi (Num_2),  --  numeric[2]
         Enc_Lo (Num_3), Enc_Hi (Num_3)]; --  numeric[3]
   begin
      return Buf;
   end Make_Bool_Num_Buffer;

   --  Parse the shared bool/num buffer and return a validated header.
   procedure Get_Bool_Num_Header
     (Buffer  :     Byte_Array;
   ...
   is
      pragma Unreferenced (T);
      Buffer  : constant Byte_Array := Make_Bool_Num_Buffer
        (16#01#, 16#00#, 16#FF#, 16#FE#, 0, 0, 0, 0);
      Header  : Parsed_Header;
      Success : Boolean;
   ...
   begin
      ...
      Assert (Result = True_Value,
              "Get_Boolean: byte=1 should return True_Value");
   ...
   begin
      ...
      Assert (Result = False_Value,
              "Get_Boolean: byte=0 should return False_Value");
   ...
   begin
      ...
      Assert (Result = Cancelled,
              "Get_Boolean: byte=0xFF should return Cancelled");
   ...
   begin
      ...
      Assert (Result = Absent,
              "Get_Boolean: byte=0xFE should return Absent");
   ...
   begin
      ...
      Assert (Result = Absent,
              "Get_Boolean: index >= Bool_Count should return Absent");
   ...
   begin
      --  Write header
      Buffer (1)  := 16#1A#;  Buffer (2)  := 16#01#;  --  magic
      Buffer (3)  := 16#02#;  Buffer (4)  := 16#00#;  --  names_size=2
      Buffer (5)  := 16#00#;  Buffer (6)  := 16#00#;  --  bool_count=0
      Buffer (7)  := 16#0E#;  Buffer (8)  := 16#00#;  --  num_count=14 (0x0E)
      Buffer (9)  := 16#00#;  Buffer (10) := 16#00#;  --  string_count=0
      Buffer (11) := 16#00#;  Buffer (12) := 16#00#;  --  table_size=0
      --  Names section (bytes 13..14)
      Buffer (13) := 16#74#;  Buffer (14) := 16#00#;  --  "t\0"
      ...
      Buffer (41) := 16#00#;  Buffer (42) := 16#01#;  --  256 in LE
      declare
         Header  : Parsed_Header;
         Success : Boolean;
         Colors  : Integer;
      begin
         ...
         Assert (Colors = 256,
                 "Get_Numeric: COLORS_INDEX with LE 0x00 0x01 should return 256");
      end;
   ...
   is
      ...
      Buffer : constant Byte_Array (1 .. 16) :=
        [16#1A#, 16#01#,  --  magic
         ...
         16#00#, 16#00#,  --  table_size=0
         16#74#, 16#00#,  --  names "t\0"
         16#FF#, 16#FF#]; --  numeric[0] = -1 (ABSENT_NUMERIC)
      Header  : Parsed_Header;
      Success : Boolean;
      Value   : Integer;
   begin
      ...
      Assert (Value = ABSENT_NUMERIC,
              "Get_Numeric: LE 0xFF 0xFF should return ABSENT_NUMERIC (-1)");
   ...
   is
      ...
      Buffer : constant Byte_Array (1 .. 16) :=
        [16#1A#, 16#01#,
         ...
         16#00#, 16#00#,
         16#74#, 16#00#,
         16#FE#, 16#FF#];  --  numeric[0] = -2 (CANCELLED_NUMERIC)
      Header  : Parsed_Header;
      Success : Boolean;
      Value   : Integer;
   begin
      ...
      Value := Get_Numeric (Buffer, Header, Legacy_16bit, 0);
      Assert (Value = CANCELLED_NUMERIC,
              "Get_Numeric: LE 0xFE 0xFF should return CANCELLED_NUMERIC (-2)");
   ...
   is
      ...
      Buffer : constant Byte_Array (1 .. 18) :=
        [16#1A#, 16#01#,
         16#02#, 16#00#,
         16#00#, 16#00#,
         16#02#, 16#00#,  --  num_count=2
         16#00#, 16#00#,
         16#00#, 16#00#,
         16#74#, 16#00#,
         16#08#, 16#00#,  --  numeric[0] = 8
         16#10#, 16#00#]; --  numeric[1] = 16
      Header  : Parsed_Header;
      Success : Boolean;
      Value   : Integer;
   begin
      ...
      Assert (Value = ABSENT_NUMERIC,
              "Get_Numeric: index >= Num_Count should return ABSENT_NUMERIC");
   ...
   begin
      Buffer (1)  := 16#1E#;  Buffer (2)  := 16#02#;  --  magic Extended_32bit
      Buffer (3)  := 16#02#;  Buffer (4)  := 16#00#;  --  names_size=2
      Buffer (5)  := 16#00#;  Buffer (6)  := 16#00#;  --  bool_count=0
      Buffer (7)  := 16#0E#;  Buffer (8)  := 16#00#;  --  num_count=14
      Buffer (9)  := 16#00#;  Buffer (10) := 16#00#;  --  string_count=0
      Buffer (11) := 16#00#;  Buffer (12) := 16#00#;  --  table_size=0
      Buffer (13) := 16#74#;  Buffer (14) := 16#00#;  --  names "t\0"
      ...
      Buffer (67) := 16#00#;  Buffer (68) := 16#00#;
      Buffer (69) := 16#00#;  Buffer (70) := 16#01#;  --  0x01000000 = 16777216
      declare
         Header  : Parsed_Header;
         Success : Boolean;
         Colors  : Integer;
      begin
         ...
         Assert (Colors = 16_777_216,
                 "Get_Numeric: Extended_32bit LE 0x00 0x00 0x00 0x01 should return 16777216");
      end;
   ...
   begin
      --  Header
      Buffer (1)  := 16#1A#;  Buffer (2)  := 16#01#;  --  magic Legacy
      Buffer (3)  := 16#02#;  Buffer (4)  := 16#00#;  --  names_size=2
      Buffer (5)  := 16#00#;  Buffer (6)  := 16#00#;  --  bool_count=0
      Buffer (7)  := 16#00#;  Buffer (8)  := 16#00#;  --  num_count=0
      --  string_count=360 (0x0168)
      Buffer (9)  := 16#68#;  Buffer (10) := 16#01#;
      --  table_size=9
      Buffer (11) := 16#09#;  Buffer (12) := 16#00#;
      --  Names section (bytes 13..14): "t\0"
      Buffer (13) := 16#74#;  Buffer (14) := 16#00#;
      ...
      Buffer (733) := 16#00#;  Buffer (734) := 16#00#;
      ...
      begin
         ...
         Assert (Present,
                 "Get_String: setaf at SETAF_INDEX should be Present=True");
         Assert (Result.Length > 0,
                 "Get_String: setaf result should have non-zero Length");
         --  First byte of setaf should be ESC (0x1B = Character'Val (27))
         Assert (Result.Data (1) = Character'Val (16#1B#),
                 "Get_String: first byte of setaf should be ESC (0x1B)");
      end;
   ...
   is
      ...
      Buffer : constant Byte_Array (1 .. 18) :=
        [16#1A#, 16#01#,
         ...
         16#00#, 16#00#,
         16#00#, 16#00#,
         16#02#, 16#00#,  --  string_count=2
         16#00#, 16#00#,  --  table_size=0
         16#74#, 16#00#,  --  names "t\0"
         16#FF#, 16#FF#,  --  string offset[0] = -1 (absent)
         16#FF#, 16#FF#]; --  string offset[1] = -1 (absent)
      Header  : Parsed_Header;
      Success : Boolean;
      Result  : Capability_String;
      Present : Boolean;
   begin
      ...
      Assert (not Present,
              "Get_String: absent offset (-1) should return Present=False");
      Assert (Result.Length = 0,
              "Get_String: absent string should have Length=0");
   ...
   is
      ...
      Buffer : constant Byte_Array (1 .. 16) :=
        [16#1A#, 16#01#,
         ...
         16#00#, 16#00#,
         16#00#, 16#00#,
         16#01#, 16#00#,  --  string_count=1
         16#00#, 16#00#,  --  table_size=0
         16#74#, 16#00#,  --  names
         16#00#, 16#00#]; --  string offset[0] = 0 (would be valid, but index 5 is OOB)
      Header  : Parsed_Header;
      Success : Boolean;
      Result  : Capability_String;
      Present : Boolean;
   begin
      ...
      Assert (not Present,
              "Get_String: index >= String_Count should return Present=False");
      Assert (Result.Length = 0,
              "Get_String: out-of-range string should have Length=0");
   ...
   begin
      --  Header
      Buffer (1)  := 16#1A#;  Buffer (2)  := 16#01#;
      Buffer (3)  := 16#02#;  Buffer (4)  := 16#00#;  --  names_size=2
      Buffer (5)  := 16#00#;  Buffer (6)  := 16#00#;  --  bool_count=0
      Buffer (7)  := 16#00#;  Buffer (8)  := 16#00#;  --  num_count=0
      Buffer (9)  := 16#01#;  Buffer (10) := 16#00#;  --  string_count=1
      Buffer (11) := LE16_Lo (Long_Size);
      Buffer (12) := LE16_Hi (Long_Size);              --  table_size
      Buffer (13) := 16#74#;  Buffer (14) := 16#00#;  --  names "t\0"
      Buffer (15) := 16#00#;  Buffer (16) := 16#00#;  --  offset[0] = 0
      ...
      begin
         ...
         Get_String (Buffer, Header, 0, Result, Present);
         Assert (Present,
                 "Get_String: long string should still be Present=True");
         Assert (Result.Length = MAX_CAPABILITY_STRING_LENGTH,
   ...
   begin
      ...
      Assert (not Ext_Ok,
              "Parse_Extended_Header: no room for extended section -> Success=False");
   ...
   is
      ...
      Buffer : constant Byte_Array (1 .. 32) :=
        [ --  Standard header
         ...
         16#01#, 16#00#,   --  Ext_Bool_Count=1
         16#00#, 16#00#,   --  Ext_Num_Count=0
         16#01#, 16#00#,   --  Ext_String_Count=1
         16#01#, 16#00#,   --  Ext_String_Entries=1
         16#04#, 16#00#,   --  Ext_Table_Size=4
   ...
   begin
      ...
      Assert (Ext_Ok,
              "Parse_Extended_Header: valid extended section should succeed");
      Assert (Ext.Ext_Bool_Count = 1,
              "Parse_Extended_Header: Ext_Bool_Count should be 1");
      Assert (Ext.Ext_Num_Count = 0,
              "Parse_Extended_Header: Ext_Num_Count should be 0");
   ...
   function Make_Ext_Bool_Buffer
     (Name_Data : Byte_Array; Bool_Val : Byte) return Byte_Array
   is
   ...
   is
      ...
      RGB_Name : constant Byte_Array (1 .. 4) :=
        [16#52#, 16#47#, 16#42#, 16#00#];
   ...
   begin
      ...
      Assert (Has_RGB,
              "Extract_Truecolor_Flags: extended bool 'RGB'=1 should set Has_RGB=True");
      Assert (not Has_Tc,
              "Extract_Truecolor_Flags: no 'Tc' present, Has_Tc should be False");
   ...
   is
      ...
      Tc_Name : constant Byte_Array (1 .. 4) :=
        [16#54#, 16#63#, 16#00#, 16#00#];
   ...
   begin
      ...
      Extract_Truecolor_Flags (Buffer, Header, Ext, Legacy_16bit, Has_RGB, Has_Tc);
      Assert (Has_Tc,
              "Extract_Truecolor_Flags: extended bool 'Tc'=1 should set Has_Tc=True");
      Assert (not Has_RGB,
              "Extract_Truecolor_Flags: no 'RGB' present, Has_RGB should be False");
   ...
   is
      ...
      Other_Name : constant Byte_Array (1 .. 4) :=
        [16#58#, 16#79#, 16#00#, 16#00#];
   ...
   begin
      ...
      Extract_Truecolor_Flags (Buffer, Header, Ext, Legacy_16bit, Has_RGB, Has_Tc);
      Assert (not Has_RGB,
              "Extract_Truecolor_Flags: unrelated extended bool -> Has_RGB=False");
      Assert (not Has_Tc,
              "Extract_Truecolor_Flags: unrelated extended bool -> Has_Tc=False");
   ...
   begin
      ...
      Buffer (41) := 16#08#;  Buffer (42) := 16#00#;
      Result := Parse_Buffer (Buffer, 42);
      Assert (Result.Success,
              "Parse_Buffer: valid legacy buffer should return Success=True");
      Assert (Result.Snapshot.Colors = 8,
              "Parse_Buffer: Colors capability should be 8");
      Assert (not Result.Snapshot.Has_Setaf,
              "Parse_Buffer: Has_Setaf should be False (no string capabilities)");
      Assert (not Result.Snapshot.Has_Setab,
              "Parse_Buffer: Has_Setab should be False (no string capabilities)");
      Assert (not Result.Snapshot.Has_RGB_Flag,
              "Parse_Buffer: Has_RGB_Flag should be False (no extended section)");
      Assert (not Result.Snapshot.Has_Tc_Flag,
              "Parse_Buffer: Has_Tc_Flag should be False (no extended section)");
   ...
   begin
      Assert (not Result.Success,
              "Parse_Buffer: wrong magic should return Success=False");
      Assert (Result.Error = Error_Invalid_Magic,
              "Parse_Buffer: wrong magic should return Error_Invalid_Magic");
   ...
   begin
      Assert (not Result.Success,
              "Parse_Buffer: 2-byte buffer with valid magic but no header should fail");
      --  The implementation may return Error_Header_Corrupt since header parsing fails.
      Assert (Result.Error = Error_Header_Corrupt,
