...
package body Test_Cell_Width is
   ...
   begin
      ...
      Register_Routine
        (T, Test_Table_Version_Unicode3_Is_First'Access, "FUNC-CWM-004: Unicode_3 is Table_Version'First");
      Register_Routine
        (T, Test_Table_Version_Unicode16_Is_Last'Access, "FUNC-CWM-004: Unicode_16 is Table_Version'Last");
      Register_Routine
        (T, Test_Table_Version_Ordering'Access, "FUNC-CWM-004: ordering Unicode_3 < Unicode_13 < Unicode_16");

      --  FUNC-CWM-006: Default version selection
      Register_Routine
        (T, Test_Active_Version_Valid'Access, "FUNC-CWM-006: Active_Version returns a valid Table_Version");
      Register_Routine
        (T,
         Test_Active_Version_In_Bounds'Access,
         "FUNC-CWM-006: Active_Version is within Table_Version enumeration bounds");

      --  FUNC-CWM-010: ASCII printable fast path
      Register_Routine (T, Test_ASCII_Space'Access, "FUNC-CWM-010: U+0020 SPACE returns 1");
      Register_Routine (T, Test_ASCII_Capital_A'Access, "FUNC-CWM-010: U+0041 LATIN CAPITAL LETTER A returns 1");
      Register_Routine (T, Test_ASCII_Tilde'Access, "FUNC-CWM-010: U+007E TILDE returns 1 (last ASCII printable)");
      Register_Routine (T, Test_ASCII_Exclamation'Access, "FUNC-CWM-010: U+0021 EXCLAMATION MARK returns 1");
      Register_Routine (T, Test_ASCII_Digit_Zero'Access, "FUNC-CWM-010: U+0030 DIGIT ZERO returns 1");
      Register_Routine (T, Test_ASCII_Lower_Z'Access, "FUNC-CWM-010: U+007A LATIN SMALL LETTER Z returns 1");
      Register_Routine (T, Test_ASCII_All_Printables'Access, "FUNC-CWM-010: all codepoints U+0020..U+007E return 1");
      Register_Routine
        (T,
         Test_ASCII_Fast_Path_All_Versions_Unicode3'Access,
         "FUNC-CWM-010: ASCII fast path holds for Unicode_3 table");
      Register_Routine
        (T,
         Test_ASCII_Fast_Path_All_Versions_Unicode13'Access,
         "FUNC-CWM-010: ASCII fast path holds for Unicode_13 table");
      Register_Routine
        (T,
         Test_ASCII_Fast_Path_All_Versions_Unicode16'Access,
         "FUNC-CWM-010: ASCII fast path holds for Unicode_16 table");

      --  FUNC-CWM-011: Control characters return 0
      Register_Routine (T, Test_Control_NUL'Access, "FUNC-CWM-011: U+0000 NUL returns 0");
      Register_Routine (T, Test_Control_TAB'Access, "FUNC-CWM-011: U+0009 TAB returns 0");
      Register_Routine (T, Test_Control_LF'Access, "FUNC-CWM-011: U+000A LINE FEED returns 0");
      Register_Routine (T, Test_Control_CR'Access, "FUNC-CWM-011: U+000D CARRIAGE RETURN returns 0");
      Register_Routine (T, Test_Control_ESC'Access, "FUNC-CWM-011: U+001B ESCAPE returns 0");
      Register_Routine (T, Test_Control_US'Access, "FUNC-CWM-011: U+001F UNIT SEPARATOR returns 0 (last C0 control)");
      Register_Routine (T, Test_Control_DEL'Access, "FUNC-CWM-011: U+007F DEL returns 0");
      Register_Routine (T, Test_Control_C1_PAD'Access, "FUNC-CWM-011: U+0080 PAD (first C1 control) returns 0");
      Register_Routine
        (T, Test_Control_C1_APC'Access, "FUNC-CWM-011: U+009F APPLICATION PROGRAM COMMAND (last C1) returns 0");
      Register_Routine (T, Test_Control_C1_NEL'Access, "FUNC-CWM-011: U+0085 NEXT LINE (mid C1 range) returns 0");

      --  FUNC-CWM-007: ZWJ returns 0
      Register_Routine (T, Test_ZWJ_Active_Version'Access, "FUNC-CWM-007: U+200D ZWJ returns 0 (active version)");
      Register_Routine (T, Test_ZWJ_Unicode3'Access, "FUNC-CWM-007: U+200D ZWJ returns 0 with Unicode_3 table");
      Register_Routine (T, Test_ZWJ_Unicode13'Access, "FUNC-CWM-007: U+200D ZWJ returns 0 with Unicode_13 table");
      Register_Routine (T, Test_ZWJ_Unicode16'Access, "FUNC-CWM-007: U+200D ZWJ returns 0 with Unicode_16 table");

      --  FUNC-CWM-008: VS16 returns 0
      Register_Routine (T, Test_VS16_Active_Version'Access, "FUNC-CWM-008: U+FE0F VS16 returns 0 (active version)");
      Register_Routine (T, Test_VS16_Unicode3'Access, "FUNC-CWM-008: U+FE0F VS16 returns 0 with Unicode_3 table");
      Register_Routine (T, Test_VS16_Unicode13'Access, "FUNC-CWM-008: U+FE0F VS16 returns 0 with Unicode_13 table");
      Register_Routine (T, Test_VS16_Unicode16'Access, "FUNC-CWM-008: U+FE0F VS16 returns 0 with Unicode_16 table");

      --  FUNC-CWM-009: Combining characters return 0
      Register_Routine (T, Test_Combining_Grave_Accent'Access, "FUNC-CWM-009: U+0300 COMBINING GRAVE ACCENT returns 0");
      Register_Routine
        (T, Test_Combining_Latin_Small_X'Access, "FUNC-CWM-009: U+036F COMBINING LATIN SMALL LETTER X returns 0");
      Register_Routine (T, Test_Combining_Acute_Accent'Access, "FUNC-CWM-009: U+0301 COMBINING ACUTE ACCENT returns 0");
      Register_Routine
        (T, Test_Combining_Left_Harpoon'Access, "FUNC-CWM-009: U+20D0 COMBINING LEFT HARPOON ABOVE returns 0");
      Register_Routine (T, Test_Combining_Unicode3_Table'Access, "FUNC-CWM-009: U+0300 returns 0 with Unicode_3 table");
      Register_Routine
        (T, Test_Combining_Unicode13_Table'Access, "FUNC-CWM-009: U+0300 returns 0 with Unicode_13 table");
      Register_Routine
        (T, Test_Combining_Unicode16_Table'Access, "FUNC-CWM-009: U+0300 returns 0 with Unicode_16 table");

      --  Wide / fullwidth characters (FUNC-CWM-016 category 6)
      Register_Routine (T, Test_Wide_CJK_4E00'Access, "FUNC-CWM-016: U+4E00 CJK UNIFIED IDEOGRAPH returns 2");
      Register_Routine
        (T, Test_Wide_Fullwidth_Exclamation'Access, "FUNC-CWM-016: U+FF01 FULLWIDTH EXCLAMATION MARK returns 2");
      Register_Routine (T, Test_Wide_Emoji_Grinning_Face'Access, "FUNC-CWM-016: U+1F600 GRINNING FACE emoji returns 2");
      Register_Routine (T, Test_Wide_CJK_Unicode16'Access, "FUNC-CWM-016: U+4E00 CJK returns 2 with Unicode_16 table");
      Register_Routine
        (T,
         Test_Wide_Fullwidth_Unicode13'Access,
      ...
      Register_Routine
        (T, Test_Narrow_E_Acute'Access, "FUNC-CWM-016: U+00E9 LATIN SMALL LETTER E WITH ACUTE returns 1");
      Register_Routine (T, Test_Narrow_Greek_Alpha'Access, "FUNC-CWM-016: U+03B1 GREEK SMALL LETTER ALPHA returns 1");
      Register_Routine
        (T, Test_Narrow_A_Grave'Access, "FUNC-CWM-016: U+00C0 LATIN CAPITAL LETTER A WITH GRAVE returns 1");

      --  Version-specific boundary codepoints (FUNC-CWM-016 category 8)
      Register_Routine
        (T,
         Test_Version_Braille_Unicode3'Access,
         "FUNC-CWM-016: U+28FF BRAILLE PATTERN DOTS-12345678 with Unicode_3 returns 1");
      Register_Routine
        (T, Test_Version_Sextant_Unicode13'Access, "FUNC-CWM-016: U+1FB38 with Unicode_13 table returns 1");
      Register_Routine
        (T, Test_Version_Legacy_Supplement_Unicode16'Access, "FUNC-CWM-016: U+1CD00 with Unicode_16 table returns 1");

      --  FUNC-CWM-003: Binary search edge cases
      Register_Routine
        (T, Test_Binary_Search_Min_Codepoint'Access, "FUNC-CWM-003: U+0000 (minimum) returns 0 via C0 control path");
      Register_Routine
        (T, Test_Binary_Search_Max_Codepoint'Access, "FUNC-CWM-003: U+10FFFF (maximum) returns valid Cell_Width_Value");
      Register_Routine
        (T,
         Test_Binary_Search_Unmatched_Defaults_One'Access,
         "FUNC-CWM-003: codepoint not in any range defaults to 1 (narrow)");
      Register_Routine
        (T, Test_Binary_Search_First_Range_Boundary'Access, "FUNC-CWM-003: first combining range boundary returns 0");
      Register_Routine
        (T, Test_Binary_Search_Before_Range'Access, "FUNC-CWM-003: codepoint just before CDM range (U+02FF) returns 1");
      Register_Routine
        (T, Test_Binary_Search_After_Range'Access, "FUNC-CWM-003: codepoint just after CDM range (U+0370) returns 1");

      --  FUNC-CWM-012: Public API — both overloads
      Register_Routine
        (T,
         Test_API_Single_Arg_Returns_Valid'Access,
         "FUNC-CWM-012: single-argument Cell_Width returns valid Cell_Width_Value");
      Register_Routine
        (T,
         Test_API_Two_Arg_Returns_Valid'Access,
         "FUNC-CWM-012: two-argument Cell_Width returns valid Cell_Width_Value");
      Register_Routine
        (T,
         Test_API_Both_Overloads_Agree'Access,
         "FUNC-CWM-012: single-arg and two-arg overloads agree for same codepoint");
      Register_Routine
        (T,
         Test_API_Return_In_Range'Access,
      ...
      Register_Routine
        (T, Test_Table_Unicode3_Non_Empty'Access, "FUNC-CWM-001: TABLE_UNICODE_3 has at least one entry");
      Register_Routine
        (T, Test_Table_Unicode13_Non_Empty'Access, "FUNC-CWM-001: TABLE_UNICODE_13 has at least one entry");
      Register_Routine
        (T, Test_Table_Unicode16_Non_Empty'Access, "FUNC-CWM-001: TABLE_UNICODE_16 has at least one entry");
      Register_Routine
        (T, Test_Table_Unicode3_Widths_Valid'Access, "FUNC-CWM-002: all TABLE_UNICODE_3 entries have Width in 0..2");
      Register_Routine
        (T, Test_Table_Unicode13_Widths_Valid'Access, "FUNC-CWM-002: all TABLE_UNICODE_13 entries have Width in 0..2");
      Register_Routine
        (T, Test_Table_Unicode16_Widths_Valid'Access, "FUNC-CWM-002: all TABLE_UNICODE_16 entries have Width in 0..2");
      Register_Routine
        (T, Test_Table_Unicode3_Last_Ge_First'Access, "FUNC-CWM-002: all TABLE_UNICODE_3 entries have Last >= First");
      Register_Routine
        (T, Test_Table_Unicode13_Last_Ge_First'Access, "FUNC-CWM-002: all TABLE_UNICODE_13 entries have Last >= First");
      Register_Routine
        (T, Test_Table_Unicode16_Last_Ge_First'Access, "FUNC-CWM-002: all TABLE_UNICODE_16 entries have Last >= First");
      Register_Routine
        (T, Test_Table_Unicode3_Sorted'Access, "FUNC-CWM-002: TABLE_UNICODE_3 is sorted with non-overlapping ranges");
      Register_Routine
        (T, Test_Table_Unicode13_Sorted'Access, "FUNC-CWM-002: TABLE_UNICODE_13 is sorted with non-overlapping ranges");
      Register_Routine
        (T, Test_Table_Unicode16_Sorted'Access, "FUNC-CWM-002: TABLE_UNICODE_16 is sorted with non-overlapping ranges");
   end Register_Tests;
   ...
   procedure Test_Table_Version_Unicode3_Is_First (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Table_Version'First = Unicode_3, "Table_Version'First should be Unicode_3 (oldest/smallest version)");
   ...
   procedure Test_Table_Version_Unicode16_Is_Last (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Table_Version'Last = Unicode_16, "Table_Version'Last should be Unicode_16 (latest bundled version)");
   ...
   begin
      ...
      Assert (V = Table_Version'Last, "Active_Version should equal Table_Version'Last when UNICODE_VERSION is not set");
   ...
   begin
      ...
      for CP in 16#0020# .. 16#007E# loop
         Assert (Cell_Width (CP) = 1, "Every codepoint in U+0020..U+007E should have cell width 1 (ASCII fast path)");
      end loop;
   ...
   begin
      ...
      Assert (Cell_Width (16#0041#, Unicode_3) = 1, "U+0041 'A' should return 1 with Unicode_3 table");
      Assert (Cell_Width (16#007E#, Unicode_3) = 1, "U+007E TILDE should return 1 with Unicode_3 table");
   ...
   begin
      ...
      Assert (Cell_Width (16#0041#, Unicode_13) = 1, "U+0041 'A' should return 1 with Unicode_13 table");
      Assert (Cell_Width (16#007E#, Unicode_13) = 1, "U+007E TILDE should return 1 with Unicode_13 table");
   ...
   begin
      ...
      Assert (Cell_Width (16#0041#, Unicode_16) = 1, "U+0041 'A' should return 1 with Unicode_16 table");
      Assert (Cell_Width (16#007E#, Unicode_16) = 1, "U+007E TILDE should return 1 with Unicode_16 table");
   ...
   procedure Test_ZWJ_Active_Version (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#200D#) = 0, "U+200D ZERO WIDTH JOINER should have cell width 0 (active table version)");
   end Test_ZWJ_Active_Version;

   procedure Test_ZWJ_Unicode3 (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#200D#, Unicode_3) = 0, "U+200D ZWJ should have cell width 0 with Unicode_3 table");
   end Test_ZWJ_Unicode3;

   procedure Test_ZWJ_Unicode13 (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#200D#, Unicode_13) = 0, "U+200D ZWJ should have cell width 0 with Unicode_13 table");
   end Test_ZWJ_Unicode13;

   procedure Test_ZWJ_Unicode16 (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#200D#, Unicode_16) = 0, "U+200D ZWJ should have cell width 0 with Unicode_16 table");
   ...
   begin
      Assert
        (Cell_Width (16#FE0F#) = 0, "U+FE0F VARIATION SELECTOR-16 should have cell width 0 (active table version)");
   end Test_VS16_Active_Version;

   procedure Test_VS16_Unicode3 (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#FE0F#, Unicode_3) = 0, "U+FE0F VS16 should have cell width 0 with Unicode_3 table");
   end Test_VS16_Unicode3;

   procedure Test_VS16_Unicode13 (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#FE0F#, Unicode_13) = 0, "U+FE0F VS16 should have cell width 0 with Unicode_13 table");
   end Test_VS16_Unicode13;

   procedure Test_VS16_Unicode16 (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#FE0F#, Unicode_16) = 0, "U+FE0F VS16 should have cell width 0 with Unicode_16 table");
   ...
   procedure Test_Combining_Grave_Accent (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#0300#) = 0, "U+0300 COMBINING GRAVE ACCENT should have cell width 0");
   ...
   procedure Test_Combining_Acute_Accent (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#0301#) = 0, "U+0301 COMBINING ACUTE ACCENT should have cell width 0");
   end Test_Combining_Acute_Accent;

   procedure Test_Combining_Left_Harpoon (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#20D0#) = 0, "U+20D0 COMBINING LEFT HARPOON ABOVE should have cell width 0");
   ...
   procedure Test_Wide_CJK_4E00 (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#4E00#) = 2, "U+4E00 CJK UNIFIED IDEOGRAPH-4E00 should have cell width 2");
   end Test_Wide_CJK_4E00;

   procedure Test_Wide_Fullwidth_Exclamation (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#FF01#) = 2, "U+FF01 FULLWIDTH EXCLAMATION MARK should have cell width 2");
   end Test_Wide_Fullwidth_Exclamation;

   procedure Test_Wide_Emoji_Grinning_Face (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#1F600#) = 2, "U+1F600 GRINNING FACE emoji should have cell width 2");
   ...
   procedure Test_Narrow_E_Acute (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#00E9#) = 1, "U+00E9 LATIN SMALL LETTER E WITH ACUTE should have cell width 1");
   end Test_Narrow_E_Acute;

   procedure Test_Narrow_Greek_Alpha (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#03B1#) = 1, "U+03B1 GREEK SMALL LETTER ALPHA should have cell width 1");
   end Test_Narrow_Greek_Alpha;

   procedure Test_Narrow_A_Grave (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Cell_Width (16#00C0#) = 1, "U+00C0 LATIN CAPITAL LETTER A WITH GRAVE should have cell width 1");
   ...
   begin
      ...
      Assert (Cell_Width (0) = 0, "U+0000 NUL (minimum codepoint) should have cell width 0 via C0 control fast path");
   ...
   begin
      ...
      Assert (W = 0 or else W = 1 or else W = 2, "U+10FFFF (maximum codepoint) should return 0, 1, or 2");
   ...
   begin
      ...
      Assert (Cell_Width (16#FFFFF#) = 1, "U+FFFFF (unmatched codepoint) should default to cell width 1 (narrow)");
   ...
   begin
      ...
      Assert (Cell_Width (16#0041#) = 1, "Single-argument Cell_Width (U+0041 'A') should return 1");
   ...
   begin
      ...
      Assert
        (Cell_Width (16#0041#, Unicode_16) = 1, "Two-argument Cell_Width (U+0041 'A', Unicode_16) should return 1");
   ...
   begin
      Assert (W1 = W2, "Cell_Width(CP) and Cell_Width(CP, Active_Version) should return the same value");
   ...
   begin
      for CP of Codepoints loop
         ...
         begin
            Assert (W = 0 or else W = 1 or else W = 2, "Cell_Width should always return 0, 1, or 2");
         end;
      end loop;
   ...
   procedure Test_Table_Unicode3_Non_Empty (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (TABLE_UNICODE_3'Length > 0, "TABLE_UNICODE_3 should contain at least one width entry");
   end Test_Table_Unicode3_Non_Empty;

   procedure Test_Table_Unicode13_Non_Empty (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (TABLE_UNICODE_13'Length > 0, "TABLE_UNICODE_13 should contain at least one width entry");
   end Test_Table_Unicode13_Non_Empty;

   procedure Test_Table_Unicode16_Non_Empty (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (TABLE_UNICODE_16'Length > 0, "TABLE_UNICODE_16 should contain at least one width entry");
   ...
   begin
      ...
      for I in TABLE_UNICODE_3'Range loop
         Assert
           (TABLE_UNICODE_3 (I).Width = 0 or else TABLE_UNICODE_3 (I).Width = 1 or else TABLE_UNICODE_3 (I).Width = 2,
            "TABLE_UNICODE_3: entry Width should be in 0..2");
         Assert
           (TABLE_UNICODE_3 (I).Last >= TABLE_UNICODE_3 (I).First, "TABLE_UNICODE_3: entry Last should be >= First");
      end loop;
   ...
   begin
      for I in TABLE_UNICODE_13'Range loop
         ...
         Assert
           (TABLE_UNICODE_13 (I).Last >= TABLE_UNICODE_13 (I).First, "TABLE_UNICODE_13: entry Last should be >= First");
      end loop;
   ...
   begin
      for I in TABLE_UNICODE_16'Range loop
         ...
         Assert
           (TABLE_UNICODE_16 (I).Last >= TABLE_UNICODE_16 (I).First, "TABLE_UNICODE_16: entry Last should be >= First");
      end loop;
