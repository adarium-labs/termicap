...
package body Test_Parse_Kitty_Version is
   ...
   begin
      --  Valid inputs
      Register_Routine (T, Test_Parse_0_20_0'Access, "FUNC-HYP-022: Parse_Kitty_Version(0.20.0) = 2000");
      Register_Routine (T, Test_Parse_0_19_0'Access, "FUNC-HYP-022: Parse_Kitty_Version(0.19.0) = 1900");
      Register_Routine (T, Test_Parse_1_2_3'Access, "FUNC-HYP-022: Parse_Kitty_Version(1.2.3) = 10203");
      Register_Routine (T, Test_Parse_0_0_0'Access, "FUNC-HYP-022: Parse_Kitty_Version(0.0.0) = 0");
      Register_Routine (T, Test_Parse_0_35_2'Access, "FUNC-HYP-022: Parse_Kitty_Version(0.35.2) = 3502");

      --  Invalid inputs -> 0
      Register_Routine (T, Test_Parse_Empty'Access, "FUNC-HYP-022: Parse_Kitty_Version("""") = 0");
      Register_Routine (T, Test_Parse_Leading_V'Access, "FUNC-HYP-022: Parse_Kitty_Version(v0.20.0) = 0 (leading v)");
      Register_Routine
        (T, Test_Parse_Pre_Release_Suffix'Access, "FUNC-HYP-022: Parse_Kitty_Version(0.20.0-rc1) = 0 (suffix)");
      Register_Routine (T, Test_Parse_Garbage'Access, "FUNC-HYP-022: Parse_Kitty_Version(garbage) = 0");
      Register_Routine (T, Test_Parse_Double_Dot'Access, "FUNC-HYP-022: Parse_Kitty_Version(1..2) = 0");

      --  Edge cases
      Register_Routine (T, Test_Parse_High_Major'Access, "FUNC-HYP-022: Parse_Kitty_Version(2.0.0) = 20000");
      Register_Routine (T, Test_Zero_On_Failure_Regression'Access, "FUNC-SXL-003: failure preserves zero (regression)");
   end Register_Tests;
   ...
   begin
      ...
      Assert (Parse_Kitty_Version ("0.20.0") = 2000, "Parse_Kitty_Version(0.20.0) should return 2000");
   ...
   begin
      ...
      Assert (Parse_Kitty_Version ("0.19.0") = 1900, "Parse_Kitty_Version(0.19.0) should return 1900");
   ...
   begin
      ...
      Assert (Parse_Kitty_Version ("1.2.3") = 10203, "Parse_Kitty_Version(1.2.3) should return 10203");
   ...
   begin
      --  0 * 10_000 + 0 * 100 + 0 = 0
      Assert (Parse_Kitty_Version ("0.0.0") = 0, "Parse_Kitty_Version(0.0.0) should return 0");
   ...
   begin
      ...
      Assert (Parse_Kitty_Version ("0.35.2") = 3502, "Parse_Kitty_Version(0.35.2) should return 3502");
   ...
   procedure Test_Parse_Empty (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Parse_Kitty_Version ("") = 0, "Parse_Kitty_Version("""") should return 0 (empty input)");
   ...
   begin
      Assert
        (Parse_Kitty_Version ("v0.20.0") = 0, "Parse_Kitty_Version(v0.20.0) should return 0 (leading 'v' is invalid)");
   ...
   begin
      Assert
        (Parse_Kitty_Version ("0.20.0-rc1") = 0, "Parse_Kitty_Version(0.20.0-rc1) should return 0 (suffix is invalid)");
   end Test_Parse_Pre_Release_Suffix;

   procedure Test_Parse_Garbage (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Parse_Kitty_Version ("garbage") = 0, "Parse_Kitty_Version(garbage) should return 0");
   end Test_Parse_Garbage;

   procedure Test_Parse_Double_Dot (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   begin
      Assert (Parse_Kitty_Version ("1..2") = 0, "Parse_Kitty_Version(1..2) should return 0 (double dot)");
   ...
   begin
      ...
      Assert (Parse_Kitty_Version ("2.0.0") = 20000, "Parse_Kitty_Version(2.0.0) should return 20000");
