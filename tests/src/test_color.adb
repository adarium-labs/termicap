...
package body Test_Color is
   ...
   begin
      --  FUNC-CLR-001
      Register_Routine (T, Test_Color_Level_Ordering'Access,
         "FUNC-CLR-001: Color_Level ordering: None < Basic_16 < Extended_256 < True_Color");
      Register_Routine (T, Test_Color_Level_Max'Access,
         "FUNC-CLR-001: Color_Level'Max returns higher of two levels");

      --  FUNC-CLR-003
      Register_Routine (T, Test_No_Color_Empty_Disables'Access,
         "FUNC-CLR-003: NO_COLOR='' (empty) present, no force -> None");
      Register_Routine (T, Test_No_Color_One_Disables'Access,
         "FUNC-CLR-003: NO_COLOR='1' present, no force -> None");
      Register_Routine (T, Test_No_Color_Absent_Proceeds'Access,
         "FUNC-CLR-003: NO_COLOR absent -> detection proceeds normally");
      Register_Routine (T, Test_No_Color_Overridden_By_Force'Access,
         "FUNC-CLR-003: NO_COLOR + FORCE_COLOR='1' -> Basic_16 (force overrides)");

      --  FUNC-CLR-004
      Register_Routine (T, Test_Force_Color_Three_True_Color'Access,
         "FUNC-CLR-004: FORCE_COLOR='3' -> True_Color regardless");
      Register_Routine (T, Test_Force_Color_Two_Extended_256'Access,
         "FUNC-CLR-004: FORCE_COLOR='2' -> Extended_256 regardless");
      Register_Routine (T, Test_Force_Color_One_Basic_16'Access,
         "FUNC-CLR-004: FORCE_COLOR='1' -> Basic_16");
      Register_Routine (T, Test_Force_Color_Zero_None'Access,
         "FUNC-CLR-004: FORCE_COLOR='0' -> None even with COLORTERM=truecolor");
      Register_Routine (T, Test_Force_Color_False_None'Access,
         "FUNC-CLR-004: FORCE_COLOR='false' -> None");
      Register_Routine (T, Test_Force_Color_True_Basic_16'Access,
         "FUNC-CLR-004: FORCE_COLOR='true' -> Basic_16");
      Register_Routine (T, Test_Force_Color_Empty_Basic_16'Access,
         "FUNC-CLR-004: FORCE_COLOR='' (empty) -> Basic_16");
      Register_Routine (T, Test_Force_Color_Unknown_Basic_16'Access,
         "FUNC-CLR-004: FORCE_COLOR='xyz' (unknown) -> Basic_16");
      Register_Routine (T, Test_Force_Color_Three_Overrides_Dumb'Access,
         "FUNC-CLR-004: FORCE_COLOR='3' + TERM=dumb -> True_Color");
      Register_Routine (T, Test_Force_Color_Two_Overrides_Tty_Gate'Access,
         "FUNC-CLR-004: FORCE_COLOR='2' + Is_TTY=False -> Extended_256");

      --  FUNC-CLR-005
      Register_Routine (T, Test_Clicolor_Force_One_No_Tty'Access,
         "FUNC-CLR-005: CLICOLOR_FORCE='1' + Is_TTY=False -> Basic_16");
      Register_Routine (T, Test_Clicolor_Force_Zero_No_Effect'Access,
         "FUNC-CLR-005: CLICOLOR_FORCE='0' -> no effect");
      Register_Routine (T, Test_Clicolor_Force_Superseded_By_Force_Color'Access,
         "FUNC-CLR-005: CLICOLOR_FORCE='1' + FORCE_COLOR='3' -> True_Color");
      Register_Routine (T, Test_Clicolor_Force_Overrides_No_Color'Access,
         "FUNC-CLR-005: CLICOLOR_FORCE='1' + NO_COLOR -> Basic_16");

      --  FUNC-CLR-006
      Register_Routine (T, Test_Term_Dumb_No_Force_None'Access,
         "FUNC-CLR-006: TERM='dumb', no force -> None");
      Register_Routine (T, Test_Term_Dumb_With_Force_Color'Access,
         "FUNC-CLR-006: TERM='dumb' + FORCE_COLOR='1' -> Basic_16");
      Register_Routine (T, Test_Term_Dumb_Uppercase'Access,
         "FUNC-CLR-006: TERM='DUMB' (uppercase) -> None");

      --  FUNC-CLR-007
      Register_Routine (T, Test_Tty_Gate_No_Tty_None'Access,
         "FUNC-CLR-007: Is_TTY=False, no force, no CI -> None");
      Register_Routine (T, Test_Tty_Gate_Tty_No_Signal_None'Access,
         "FUNC-CLR-007: Is_TTY=True, no env vars -> None");
      Register_Routine (T, Test_Tty_Gate_Force_Color_Bypasses'Access,
         "FUNC-CLR-007: Is_TTY=False + FORCE_COLOR='1' -> Basic_16");

      --  FUNC-CLR-008
      Register_Routine (T, Test_Colorterm_Truecolor'Access,
         "FUNC-CLR-008: COLORTERM='truecolor' -> True_Color");
      Register_Routine (T, Test_Colorterm_24bit'Access,
         "FUNC-CLR-008: COLORTERM='24bit' -> True_Color");
      Register_Routine (T, Test_Colorterm_Mixed_Case'Access,
         "FUNC-CLR-008: COLORTERM='TrueColor' (mixed case) -> True_Color");
      Register_Routine (T, Test_Colorterm_Yes_Basic_16'Access,
         "FUNC-CLR-008: COLORTERM='yes' -> Basic_16");

      --  FUNC-CLR-009
      Register_Routine (T, Test_Term_Xterm_256color'Access,
         "FUNC-CLR-009: TERM='xterm-256color' -> Extended_256");
      Register_Routine (T, Test_Term_Screen_256color'Access,
         "FUNC-CLR-009: TERM='screen-256color' -> Extended_256");
      Register_Routine (T, Test_Term_Xterm_Basic_16'Access,
         "FUNC-CLR-009: TERM='xterm' -> Basic_16");
      Register_Routine (T, Test_Term_Linux_Basic_16'Access,
         "FUNC-CLR-009: TERM='linux' -> Basic_16");
      Register_Routine (T, Test_Term_Rxvt_Unicode_Basic_16'Access,
         "FUNC-CLR-009: TERM='rxvt-unicode' -> Basic_16");
      Register_Routine (T, Test_Term_Unknown_None'Access,
         "FUNC-CLR-009: TERM='unknown-terminal' -> None");

      --  FUNC-CLR-010
      Register_Routine (T, Test_Term_Program_Iterm_V3_True_Color'Access,
         "FUNC-CLR-010: TERM_PROGRAM='iTerm.app' version '3.4.0' -> True_Color");
      Register_Routine (T, Test_Term_Program_Iterm_V2_Extended_256'Access,
         "FUNC-CLR-010: TERM_PROGRAM='iTerm.app' version '2.1.0' -> Extended_256");
      Register_Routine (T, Test_Term_Program_Iterm_No_Version'Access,
         "FUNC-CLR-010: TERM_PROGRAM='iTerm.app' no version -> Extended_256");
      Register_Routine (T, Test_Term_Program_Apple_Terminal'Access,
         "FUNC-CLR-010: TERM_PROGRAM='Apple_Terminal' -> Extended_256");
      Register_Routine (T, Test_Term_Program_Vscode'Access,
         "FUNC-CLR-010: TERM_PROGRAM='vscode' -> Extended_256");

      --  FUNC-CLR-011
      Register_Routine (T, Test_Ci_Github_Actions_True_Color'Access,
         "FUNC-CLR-011: GITHUB_ACTIONS='true' -> True_Color");
      Register_Routine (T, Test_Ci_Travis_Basic_16'Access,
         "FUNC-CLR-011: TRAVIS present -> Basic_16");
      Register_Routine (T, Test_Ci_Generic_Basic_16'Access,
         "FUNC-CLR-011: CI='true' generic -> Basic_16");
      Register_Routine (T, Test_Ci_Before_Tty_Gate'Access,
         "FUNC-CLR-011: CI detection with Is_TTY=False -> still returns color");

      --  FUNC-CLR-012
      Register_Routine (T, Test_Clicolor_One_With_Tty'Access,
         "FUNC-CLR-012: CLICOLOR='1' + Is_TTY=True -> Basic_16");
      Register_Routine (T, Test_Clicolor_Zero_No_Effect'Access,
         "FUNC-CLR-012: CLICOLOR='0' -> no effect");
      Register_Routine (T, Test_Clicolor_One_No_Tty_None'Access,
         "FUNC-CLR-012: CLICOLOR='1' + Is_TTY=False -> None (post-TTY-gate)");

      --  FUNC-CLR-013
      Register_Routine (T, Test_Multiplexer_Screen_Cap'Access,
         "FUNC-CLR-013: TERM='screen' + COLORTERM='truecolor' -> Extended_256 (capped)");
      Register_Routine (T, Test_Multiplexer_Tmux_Exception'Access,
         "FUNC-CLR-013: screen-256color + COLORTERM=truecolor + TERM_PROGRAM=tmux -> True_Color");
      Register_Routine (T, Test_Multiplexer_Force_Not_Capped'Access,
         "FUNC-CLR-013: FORCE_COLOR='3' + TERM='screen' -> True_Color (force not capped)");

      --  FUNC-CLR-015
      Register_Routine (T, Test_Priority_Floor_Plus_Heuristic'Access,
   ...
   begin
      Assert
         (Color_Level'First = None,
          "Color_Level'First should be None");
      Assert
         (Color_Level'Last = True_Color,
          "Color_Level'Last should be True_Color");
      Assert
         (None < Basic_16,
          "None should be less than Basic_16");
      Assert
         (Basic_16 < Extended_256,
          "Basic_16 should be less than Extended_256");
      Assert
         (Extended_256 < True_Color,
          "Extended_256 should be less than True_Color");
      Assert
         (None < True_Color,
          "None should be less than True_Color");
   ...
   begin
      Assert
         (Color_Level'Max (None, None) = None,
          "Max(None, None) should be None");
      Assert
         (Color_Level'Max (None, Basic_16) = Basic_16,
          "Max(None, Basic_16) should be Basic_16");
      Assert
         (Color_Level'Max (Basic_16, Extended_256) = Extended_256,
          "Max(Basic_16, Extended_256) should be Extended_256");
      Assert
         (Color_Level'Max (Extended_256, True_Color) = True_Color,
          "Max(Extended_256, True_Color) should be True_Color");
      Assert
         (Color_Level'Max (True_Color, None) = True_Color,
          "Max(True_Color, None) should be True_Color");
      Assert
         (Color_Level'Max (Extended_256, Basic_16) = Extended_256,
          "Max(Extended_256, Basic_16) should be Extended_256");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = None,
          "NO_COLOR='1' with no force should return None");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => False) = True_Color,
          "FORCE_COLOR='3' should return True_Color");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => False) = Extended_256,
          "FORCE_COLOR='2' should return Extended_256");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => False) = Basic_16,
          "FORCE_COLOR='1' should return Basic_16");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = None,
          "FORCE_COLOR='false' should return None");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => False) = Basic_16,
          "FORCE_COLOR='true' should return Basic_16");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = None,
          "TERM='dumb' with no force override should return None");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = Basic_16,
          "TERM='dumb' + FORCE_COLOR='1' should return Basic_16");
   ...
   begin
      Assert
         (Detect_Color_Level (Env, Is_TTY => False) = None,
          "Is_TTY=False with no force and no CI should return None");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = True_Color,
          "COLORTERM='truecolor' should return True_Color");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = True_Color,
          "COLORTERM='24bit' should return True_Color");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = Extended_256,
          "TERM='xterm-256color' should return Extended_256");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = Extended_256,
          "TERM='screen-256color' should return Extended_256");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = Basic_16,
          "TERM='xterm' should return Basic_16");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = Basic_16,
          "TERM='linux' should return Basic_16");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = Extended_256,
          "TERM_PROGRAM='vscode' should return Extended_256");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => False) = True_Color,
          "GITHUB_ACTIONS='true' should return True_Color");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => False) = Basic_16,
          "TRAVIS present should return Basic_16");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => False) = Basic_16,
          "CI='true' (generic CI) should return Basic_16");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => True) = Basic_16,
          "CLICOLOR='1' + Is_TTY=True should return Basic_16");
   ...
   begin
      ...
      Assert
         (Detect_Color_Level (Env, Is_TTY => False) = None,
          "CLICOLOR='1' + Is_TTY=False should return None "
          & "(CLICOLOR is post-TTY-gate, so TTY gate blocks it)");
