...
package body Test_Dimensions is
   ...
   begin
      --  FUNC-DIM-001
      Register_Routine (T, Test_Default_Size'Access,
         "FUNC-DIM-001: Default Terminal_Size has correct field values");

      --  FUNC-DIM-004
      Register_Routine (T, Test_Default_Fallback_No_Env'Access,
         "FUNC-DIM-004: No env vars, Is_TTY=False -> 80x24, pixel=0");

      --  FUNC-DIM-003
      Register_Routine (T, Test_Env_Columns_And_Lines'Access,
         "FUNC-DIM-003: COLUMNS and LINES both set -> use both");
      Register_Routine (T, Test_Env_Columns_Only'Access,
         "FUNC-DIM-003: Only COLUMNS set -> use COLUMNS, default ROWS");
      Register_Routine (T, Test_Env_Lines_Only'Access,
         "FUNC-DIM-003: Only LINES set -> default COLUMNS, use LINES");
      Register_Routine (T, Test_Env_Columns_Invalid_Non_Numeric'Access,
         "FUNC-DIM-003: COLUMNS invalid (non-numeric) -> default COLUMNS");
      Register_Routine (T, Test_Env_Columns_Zero'Access,
         "FUNC-DIM-003: COLUMNS='0' -> default (0 is not Positive)");
      Register_Routine (T, Test_Env_Columns_Empty'Access,
         "FUNC-DIM-003: COLUMNS='' (empty) -> default");
      Register_Routine (T, Test_Env_Columns_Negative'Access,
         "FUNC-DIM-003: COLUMNS='-1' (negative) -> default");
      Register_Routine (T, Test_Env_Columns_Overflow'Access,
         "FUNC-DIM-003: COLUMNS='999999999999999' (overflow) -> default");
      Register_Routine (T, Test_Env_Lines_Invalid_Columns_Valid'Access,
         "FUNC-DIM-003: LINES invalid + COLUMNS valid -> partial detection");
      Register_Routine (T, Test_Env_Case_Insensitive'Access,
         "FUNC-DIM-003: Case insensitivity of env var names");

      --  FUNC-DIM-008
      Register_Routine (T, Test_Pixel_Dimensions_Zero_On_Env_Path'Access,
   ...
   procedure Test_Default_Fallback_No_Env
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
   ...
   procedure Test_Env_Columns_And_Lines
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
   ...
   procedure Test_Env_Columns_Only
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
      Env  : Environment := EMPTY_ENVIRONMENT;
   ...
   procedure Test_Env_Columns_Invalid_Non_Numeric
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
      Env  : Environment := EMPTY_ENVIRONMENT;
   ...
   procedure Test_Env_Columns_Zero
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
      Env  : Environment := EMPTY_ENVIRONMENT;
   ...
   procedure Test_Env_Columns_Empty
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
      Env  : Environment := EMPTY_ENVIRONMENT;
   ...
   procedure Test_Env_Columns_Negative
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
      Env  : Environment := EMPTY_ENVIRONMENT;
   ...
   procedure Test_Env_Columns_Overflow
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
      Env  : Environment := EMPTY_ENVIRONMENT;
   ...
   procedure Test_Env_Lines_Invalid_Columns_Valid
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
      Env  : Environment := EMPTY_ENVIRONMENT;
   ...
   procedure Test_Env_Case_Insensitive
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
      Env  : Environment := EMPTY_ENVIRONMENT;
   ...
   procedure Test_Pixel_Dimensions_Zero_On_Env_Path
      (T : in out AUnit.Test_Cases.Test_Case'Class)
   is
      pragma Unreferenced (T);
      Env  : Environment := EMPTY_ENVIRONMENT;
