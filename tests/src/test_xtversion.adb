...
package body Test_XTVERSION is
   ...
   begin
      ...
      Register_Routine
        (T, Test_Contains_Valid_ST_Terminated'Access, "FUNC-XTV-003: well-formed ESC \\ terminated -> True");
      Register_Routine
        (T, Test_Contains_Valid_BEL_Terminated'Access, "FUNC-XTV-003: well-formed BEL terminated -> True");
      Register_Routine (T, Test_Contains_Empty_Input'Access, "FUNC-XTV-003: empty input (Length=0) -> False");
      Register_Routine (T, Test_Contains_Too_Short'Access, "FUNC-XTV-003: fewer than 6 bytes -> False");
      Register_Routine
        (T, Test_Contains_Wrong_Discriminator'Access, "FUNC-XTV-003: ESC P < | wrong discriminator -> False");
      Register_Routine (T, Test_Contains_No_ST_Terminator'Access, "FUNC-XTV-003: no ST terminator -> False");
      Register_Routine
        (T,
         Test_Contains_Empty_Payload'Access,
         "FUNC-XTV-003: valid envelope but empty payload (ESC P > | ESC \\) -> False");

      --  FUNC-XTV-004: Extract_XTV_Payload
      Register_Routine
        (T, Test_Extract_Payload_Offset_Xterm'Access, "FUNC-XTV-004: xterm response -> Offset = Buf'First + 4");
      Register_Routine
        (T, Test_Extract_Payload_Length_Xterm'Access, "FUNC-XTV-004: xterm response -> Length = payload byte count");
      Register_Routine
        (T, Test_Extract_Payload_BEL_Terminated'Access, "FUNC-XTV-004: BEL-terminated -> correct payload length");

      --  FUNC-XTV-005: Split_XTV_Payload
      Register_Routine
        (T, Test_Split_Format_B_Xterm'Access, "FUNC-XTV-005: Format B xterm(388) -> Name=xterm, Version=388");
      Register_Routine
        (T, Test_Split_Format_A_Tmux'Access, "FUNC-XTV-005: Format A tmux 3.4 -> Name=tmux, Version=3.4");
      Register_Routine
        (T, Test_Split_Format_A_WezTerm'Access, "FUNC-XTV-005: Format A WezTerm date-hash -> correct tokens");
      Register_Routine
        (T, Test_Split_No_Delimiter'Access, "FUNC-XTV-005: no delimiter -> Name=full payload, Version=empty");

      --  FUNC-XTV-006 / FUNC-XTV-017: Parse_XTVERSION_Response
      Register_Routine
        (T,
         Test_Parse_Xterm_Format_B'Access,
         "FUNC-XTV-017 case 1: xterm Format B -> Success, Name=xterm, Version=388");
      Register_Routine
        (T, Test_Parse_Tmux_Format_A'Access, "FUNC-XTV-017 case 2: tmux Format A -> Success, Name=tmux, Version=3.4");
      Register_Routine
        (T, Test_Parse_WezTerm_Format_A'Access, "FUNC-XTV-017 case 3: WezTerm date-hash -> Success, correct tokens");
      Register_Routine
        (T, Test_Parse_BEL_Terminated'Access, "FUNC-XTV-017 case 4: BEL-terminated -> Success, same tokens as ESC \\");
      Register_Routine (T, Test_Parse_Empty_Input'Access, "FUNC-XTV-017 case 5: empty input -> Parse_Error");
      Register_Routine
        (T, Test_Parse_Wrong_Discriminator'Access, "FUNC-XTV-017 case 6: ESC P < | wrong discriminator -> Parse_Error");
      Register_Routine (T, Test_Parse_No_ST_Terminator'Access, "FUNC-XTV-017 case 7: no ST terminator -> Parse_Error");
      Register_Routine
        (T, Test_Parse_Empty_Payload'Access, "FUNC-XTV-017 case 8: valid envelope, empty payload -> Parse_Error");
      Register_Routine
        (T,
         Test_Parse_No_Delimiter_In_Payload'Access,
   ...
   procedure Test_Contains_Valid_ST_Terminated (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   ...
   procedure Test_Contains_Valid_BEL_Terminated (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   ...
   procedure Test_Contains_Too_Short (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  5 bytes: ESC P > | x  — has prefix and one payload byte but no ST
      Buf : constant Byte_Array (1 .. 5) := [DCS_PREFIX_1, DCS_PREFIX_2, DCS_PREFIX_3, DCS_PREFIX_4, CHR_x];
   begin
      Assert
   ...
   procedure Test_Contains_Wrong_Discriminator (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   ...
   procedure Test_Contains_No_ST_Terminator (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   ...
   procedure Test_Contains_Empty_Payload (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  ESC P > | ESC \  — valid DCS envelope but zero payload bytes
      Buf : constant Byte_Array (1 .. 6) := [DCS_PREFIX_1, DCS_PREFIX_2, DCS_PREFIX_3, DCS_PREFIX_4, ST_1, ST_2];
   begin
      Assert
        (not Contains_XTVERSION_Response (Buf, 6), "Contains_XTVERSION_Response: empty payload should return False");
   ...
   procedure Test_Extract_Payload_Offset_Xterm (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  ESC P > | x t e r m ( 3 8 8 ) ESC \
      Buf   : constant Byte_Array (1 .. 16) :=
        [DCS_PREFIX_1,
   ...
   begin
      Assert (Slice.Offset = Buf'First + 4, "Extract_XTV_Payload: Offset should be Buf'First + 4 (= 5)");
   end Test_Extract_Payload_Offset_Xterm;

   procedure Test_Extract_Payload_Length_Xterm (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  ESC P > | x t e r m ( 3 8 8 ) ESC \
      ...
      Slice : constant Payload_Slice := Extract_XTV_Payload (Buf, 16);
   begin
      Assert (Slice.Length = 10, "Extract_XTV_Payload: Length should be 10 for 'xterm(388)'");
   end Test_Extract_Payload_Length_Xterm;

   procedure Test_Extract_Payload_BEL_Terminated (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  ESC P > | x t e r m ( 3 8 8 ) BEL
   ...
   begin
      Assert (Slice.Length = 10, "Extract_XTV_Payload: BEL-terminated: Length should be 10 for 'xterm(388)'");
      Assert (Slice.Offset = Buf'First + 4, "Extract_XTV_Payload: BEL-terminated: Offset should be Buf'First + 4");
   ...
   procedure Test_Split_Format_B_Xterm (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  Payload "xterm(388)" starting at offset 1 in a 10-byte buffer
      --  x t e r m ( 3 8 8 )
      Buf    : constant Byte_Array (1 .. 10) :=
        [CHR_x, CHR_t, CHR_e, CHR_r, CHR_m, CHR_LP, CHR_3, CHR_8, CHR_8, CHR_RP];
      Tokens : constant Token_Pair := Split_XTV_Payload (Buf, 1, 10);
   begin
      Assert (Tokens.Name = To_Unbounded_String ("xterm"), "Split_XTV_Payload Format B: Name should be 'xterm'");
      Assert (Tokens.Version = To_Unbounded_String ("388"), "Split_XTV_Payload Format B: Version should be '388'");
   end Test_Split_Format_B_Xterm;

   procedure Test_Split_Format_A_Tmux (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  Payload "tmux 3.4" starting at offset 1 in an 8-byte buffer
      --  t m u x SP 3 . 4
      Buf    : constant Byte_Array (1 .. 8) := [CHR_t, CHR_m, CHR_u, CHR_x, CHR_SP, CHR_3, CHR_DT, CHR_4];
      Tokens : constant Token_Pair := Split_XTV_Payload (Buf, 1, 8);
   begin
      Assert (Tokens.Name = To_Unbounded_String ("tmux"), "Split_XTV_Payload Format A: Name should be 'tmux'");
      Assert (Tokens.Version = To_Unbounded_String ("3.4"), "Split_XTV_Payload Format A: Version should be '3.4'");
   end Test_Split_Format_A_Tmux;

   procedure Test_Split_Format_A_WezTerm (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
   ...
   begin
      Assert
        (Tokens.Name = To_Unbounded_String ("WezTerm"), "Split_XTV_Payload WezTerm Format A: Name should be 'WezTerm'");
      Assert
   ...
   procedure Test_Split_No_Delimiter (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  Payload "myterm" — no '(' and no space
      --  m y t e r m
      Buf    : constant Byte_Array (1 .. 6) := [CHR_m, CHR_t, CHR_e, CHR_r, CHR_m, CHR_t];
      Tokens : constant Token_Pair := Split_XTV_Payload (Buf, 1, 6);
   begin
      Assert (Length (Tokens.Name) > 0, "Split_XTV_Payload no delimiter: Name should be non-empty");
      Assert (Tokens.Version = Null_Unbounded_String, "Split_XTV_Payload no delimiter: Version should be empty string");
   ...
   procedure Test_Parse_Xterm_Format_B (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  FUNC-XTV-017 case 1:
      --  ESC P > | x t e r m ( 3 8 8 ) ESC \
      Buf    : constant Byte_Array (1 .. 16) :=
   ...
   begin
      Assert (Result.Status = Success, "Parse_XTVERSION_Response xterm Format B: Status should be Success");
      Assert
   ...
   procedure Test_Parse_Tmux_Format_A (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  FUNC-XTV-017 case 2:
   ...
   begin
      Assert (Result.Status = Success, "Parse_XTVERSION_Response tmux Format A: Status should be Success");
      Assert
   ...
   procedure Test_Parse_WezTerm_Format_A (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  FUNC-XTV-017 case 3:
   ...
   begin
      Assert (Result.Status = Success, "Parse_XTVERSION_Response WezTerm Format A: Status should be Success");
      Assert
   ...
   procedure Test_Parse_BEL_Terminated (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  FUNC-XTV-017 case 4:
   ...
   begin
      Assert (Result.Status = Success, "Parse_XTVERSION_Response BEL-terminated: Status should be Success");
      Assert
        (Result.Terminal_Name = To_Unbounded_String ("tmux"),
   ...
   begin
      Assert (Result.Status = Parse_Error, "Parse_XTVERSION_Response empty input: Status should be Parse_Error");
   end Test_Parse_Empty_Input;

   procedure Test_Parse_Wrong_Discriminator (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  FUNC-XTV-017 case 6:
   ...
   begin
      Assert
        (Result.Status = Parse_Error, "Parse_XTVERSION_Response wrong discriminator: Status should be Parse_Error");
   end Test_Parse_Wrong_Discriminator;

   procedure Test_Parse_No_ST_Terminator (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  FUNC-XTV-017 case 7:
      ...
      Result : constant XTVERSION_Result := Parse_XTVERSION_Response (Buf, 14);
   begin
      Assert (Result.Status = Parse_Error, "Parse_XTVERSION_Response no ST terminator: Status should be Parse_Error");
   end Test_Parse_No_ST_Terminator;

   procedure Test_Parse_Empty_Payload (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  FUNC-XTV-017 case 8:
   ...
   begin
      Assert (Result.Status = Parse_Error, "Parse_XTVERSION_Response empty payload: Status should be Parse_Error");
   end Test_Parse_Empty_Payload;

   procedure Test_Parse_No_Delimiter_In_Payload (T : in out AUnit.Test_Cases.Test_Case'Class) is
      pragma Unreferenced (T);
      --  FUNC-XTV-017 case 9:
      ...
      Result : constant XTVERSION_Result := Parse_XTVERSION_Response (Buf, 13);
   begin
      Assert (Result.Status = Success, "Parse_XTVERSION_Response no delimiter: Status should be Success");
      Assert
        (Length (Result.Terminal_Name) > 0, "Parse_XTVERSION_Response no delimiter: Terminal_Name should be non-empty");
      Assert
