...
package body Test_Unicode is
   ...
   begin
      ...
      Register_Routine
        (T,
         Test_Unicode_Level_Ordering'Access,
         "FUNC-UNI-001: Unicode_Level ordering: None < Basic < Extended");
      Register_Routine
        (T,
         Test_Unicode_Level_Max'Access,
         "FUNC-UNI-001: Unicode_Level'Max returns higher of two levels");

      --  FUNC-UNI-003
      Register_Routine
        (T,
         Test_Locale_LC_All_UTF8_Basic'Access,
         "FUNC-UNI-003: LC_ALL='en_US.UTF-8' -> Basic");
      Register_Routine
        (T,
         Test_Locale_LC_Ctype_UTF8_Basic'Access,
      ...
      Register_Routine
        (T,
         Test_Locale_UTF8_No_Separator'Access,
         "FUNC-UNI-003: LANG='utf8' (no separator) -> Basic");
      Register_Routine
        (T,
         Test_Locale_UTF8_Uppercase_Hyphen'Access,
      ...
      Register_Routine
        (T,
         Test_Locale_C_UTF8'Access,
         "FUNC-UNI-003: LANG='C.UTF-8' -> Basic");
      Register_Routine
        (T,
         Test_Locale_C_UTF8_Lowercase'Access,
         "FUNC-UNI-003: LANG='C.utf-8' (lowercase) -> Basic");
      Register_Routine
        (T,
         Test_Locale_Lang_C_None'Access,
         "FUNC-UNI-003: LANG='C' (no UTF-8), no other signals -> None");
      Register_Routine
        (T,
         Test_Locale_Lang_POSIX_None'Access,
         "FUNC-UNI-003: LANG='POSIX', no other signals -> None");
      Register_Routine
        (T,
         Test_Locale_All_Absent_None'Access,
         "FUNC-UNI-003: All locale vars absent, no other signals -> None");

      --  FUNC-UNI-004
      Register_Routine
        (T,
         Test_Term_Linux_No_Locale_None'Access,
         "FUNC-UNI-004: TERM='linux', no locale -> None");
      Register_Routine
        (T,
         Test_Term_Linux_Uppercase_None'Access,
      ...
      Register_Routine
        (T,
         Test_Windows_WT_Session_Basic'Access,
         "FUNC-UNI-005: OS_TYPE='Windows_NT', WT_SESSION present -> Basic");
      Register_Routine
        (T,
      ...
      Register_Routine
        (T,
         Test_Windows_Term_Alacritty_Basic'Access,
      ...
      Register_Routine
        (T,
         Test_Windows_No_Match_None'Access,
      ...
      Register_Routine
        (T,
         Test_CI_Github_Actions_Basic'Access,
         "FUNC-UNI-006: GITHUB_ACTIONS='true' -> Basic");
      Register_Routine
        (T,
         Test_CI_Gitea_Actions_Basic'Access,
         "FUNC-UNI-006: GITEA_ACTIONS present -> Basic");
      Register_Routine
        (T,
         Test_CI_CircleCI_Basic'Access,
         "FUNC-UNI-006: CIRCLECI present -> Basic");
      Register_Routine
        (T,
         Test_CI_Generic_Only_None'Access,
         "FUNC-UNI-006: CI='true' only (generic CI), no other signals -> None");
      Register_Routine
        (T,
      ...
      Register_Routine
        (T,
         Test_Priority_Empty_Environment_None'Access,
         "FUNC-UNI-008: Empty environment -> None");

      --  Edge cases
      Register_Routine
        (T,
         Test_Edge_All_Signals_Basic'Access,
         "Edge: All signals set (locale + CI + TERM=linux + Windows) -> Basic");
      Register_Routine
        (T,
         Test_Edge_Unicode_Level_Type_Ordering'Access,
         "Edge: Unicode_Level type ordering None < Basic < Extended");
   end Register_Tests;
   ...
   begin
      Assert
        (Unicode_Level'First = None, "Unicode_Level'First should be None");
      Assert
        (Unicode_Level'Last = Extended,
         "Unicode_Level'Last should be Extended");
   ...
   begin
      Assert
        (Unicode_Level'Max (None, None) = None,
         "Max(None, None) should be None");
      Assert
        (Unicode_Level'Max (None, Basic) = Basic,
         "Max(None, Basic) should be Basic");
      Assert
        (Unicode_Level'Max (Basic, Extended) = Extended,
         "Max(Basic, Extended) should be Extended");
      Assert
        (Unicode_Level'Max (Extended, None) = Extended,
         "Max(Extended, None) should be Extended");
      Assert
        (Unicode_Level'Max (Basic, None) = Basic,
         "Max(Basic, None) should be Basic");
      Assert
        (Unicode_Level'Max (Extended, Basic) = Extended,
         "Max(Extended, Basic) should be Extended");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "LC_ALL='en_US.UTF-8' should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "LC_CTYPE='en_US.UTF-8' with LC_ALL absent should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "LANG='en_US.UTF-8' with LC_ALL and LC_CTYPE absent should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "LANG='utf8' (no separator) should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "LANG='UTF-8' (uppercase with hyphen) should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "LANG='utf_8' (underscore separator) should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "LANG='C.UTF-8' should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "LANG='C.utf-8' (lowercase) should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = None,
         "LANG='C' (no UTF-8) with no other signals should return None");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = None,
         "LANG='POSIX' with no other signals should return None");
   ...
   begin
      Assert
        (Detect_Unicode_Level (Env) = None,
         "All locale vars absent with no other signals should return None");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = None,
         "TERM='linux' with no locale and no other signals should return None");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "OS_TYPE='Windows_NT' with WT_SESSION present should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "OS_TYPE='Windows_NT' with TERM_PROGRAM='vscode' should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "OS_TYPE='Windows_NT' with TERM='xterm-256color' should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "OS_TYPE='Windows_NT' with TERM='alacritty' should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = None,
         "WT_SESSION present but OS_TYPE absent (not Windows) should return None");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "GITHUB_ACTIONS='true' should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "GITEA_ACTIONS present should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = Basic,
         "CIRCLECI present should return Basic");
   ...
   begin
      ...
      Assert
        (Detect_Unicode_Level (Env) = None,
         "Generic CI='true' only (not in FUNC-UNI-006 list) should return None");
   ...
   begin
      ...
      Assert
        (Basic < Extended,
         "Basic < Extended should hold for Unicode_Level type");
      Assert
        (None < Extended,
         "None < Extended should hold for Unicode_Level type");
      Assert
        (not (Basic < None),
         "not (Basic < None) should hold for Unicode_Level type");
      Assert
        (not (Extended < Basic),
         "not (Extended < Basic) should hold for Unicode_Level type");
