...
package body Test_OSC_Parsing is
   ...
   begin
      ...
      Register_Routine (T, Test_Contains_DA1_Empty_Buffer'Access,
         "FUNC-OSC-006: Empty buffer (Length=0) -> False");
      Register_Routine (T, Test_Contains_DA1_No_Esc'Access,
         "FUNC-OSC-006: Buffer with no ESC bytes -> False");
      Register_Routine (T, Test_Contains_DA1_Incomplete_No_Quest'Access,
         "FUNC-OSC-006: Incomplete DA1 - ESC [ only, no ? -> False");
      Register_Routine (T, Test_Contains_DA1_Incomplete_No_Term'Access,
         "FUNC-OSC-006: Incomplete DA1 - ESC [ ? but no c terminator -> False");
      Register_Routine (T, Test_Contains_DA1_Valid_Two_Params'Access,
         "FUNC-OSC-006: Valid ESC [ ? 6 4 ; 1 c -> True");
      Register_Routine (T, Test_Contains_DA1_Non_DA1_CSI'Access,
         "FUNC-OSC-006: Non-DA1 CSI ESC [ 6 n (no ?) -> False");
      Register_Routine (T, Test_Contains_DA1_After_OSC_Response'Access,
         "FUNC-OSC-006: DA1 preceded by OSC response bytes -> True");
      Register_Routine (T, Test_Contains_DA1_Minimal_No_Params'Access,
         "FUNC-OSC-006: Minimal DA1 ESC [ ? c (no digit params) -> True");
      Register_Routine (T, Test_Contains_DA1_Multiple_Esc_Last_Is_DA1'Access,
         "FUNC-OSC-006: Multiple ESC sequences, only last is DA1 -> True");

      --  FUNC-OSC-006: DA1_Response_Start
      Register_Routine (T, Test_DA1_Start_Empty_Buffer'Access,
         "FUNC-OSC-006: DA1_Response_Start empty buffer -> returns 0 (= Length)");
      Register_Routine (T, Test_DA1_Start_No_DA1'Access,
         "FUNC-OSC-006: DA1_Response_Start no DA1 present -> returns Length");
      Register_Routine (T, Test_DA1_Start_At_First_Byte'Access,
         "FUNC-OSC-006: DA1_Response_Start DA1 at first byte -> returns 1");
      Register_Routine (T, Test_DA1_Start_After_Prefix'Access,
         "FUNC-OSC-006: DA1_Response_Start DA1 after prefix bytes -> correct index");
      Register_Routine (T, Test_DA1_Start_After_OSC11_Response'Access,
         "FUNC-OSC-006: DA1_Response_Start after OSC11 response -> DA1 ESC position");
      Register_Routine (T, Test_DA1_Start_Result_Le_Length'Access,
         "FUNC-OSC-006: DA1_Response_Start result always <= Length");

      --  FUNC-OSC-010: Parse_DA1_Response
      Register_Routine (T, Test_Parse_DA1_Empty'Access,
         "FUNC-OSC-010: Empty input (Length=0) -> Count=0");
      Register_Routine (T, Test_Parse_DA1_Two_Params'Access,
         "FUNC-OSC-010: ESC [ ? 6 4 ; 1 c -> Count=2, Values=(64,1)");
      Register_Routine (T, Test_Parse_DA1_Single_Param'Access,
         "FUNC-OSC-010: ESC [ ? 6 c -> Count=1, Values(1)=6");
      Register_Routine (T, Test_Parse_DA1_Many_Params'Access,
         "FUNC-OSC-010: ESC [ ? 1 ; 2 ; 4 ; 6 ; 9 c -> Count=5");
      Register_Routine (T, Test_Parse_DA1_No_Match'Access,
         "FUNC-OSC-010: No matching pattern -> Count=0");
      Register_Routine (T, Test_Parse_DA1_Incomplete'Access,
         "FUNC-OSC-010: Incomplete DA1 (no terminating c) -> Count=0");
      Register_Routine (T, Test_Parse_DA1_Wrong_Prefix'Access,
         "FUNC-OSC-010: Wrong prefix (no ? after [) -> Count=0");
      Register_Routine (T, Test_Parse_DA1_Count_Bounded'Access,
         "FUNC-OSC-010: Count <= MAX_DA1_PARAMS postcondition holds");
      Register_Routine (T, Test_Parse_DA1_Multi_Digit_Params'Access,
         "FUNC-OSC-010: ESC [ ? 1 5 ; 2 2 c -> Count=2, Values=(15,22)");

      --  FUNC-OSC-014: Wrap_For_Passthrough
      Register_Routine (T, Test_Wrap_No_Passthrough_Identity'Access,
         "FUNC-OSC-014: No_Passthrough returns Query unchanged");
      Register_Routine (T, Test_Wrap_No_Passthrough_Empty'Access,
         "FUNC-OSC-014: No_Passthrough with empty query -> empty result");
      Register_Routine (T, Test_Wrap_Tmux_Has_DCS_Prefix'Access,
         "FUNC-OSC-014: Tmux wrap starts with ESC P and tmux;");
      Register_Routine (T, Test_Wrap_Tmux_Has_ST_Suffix'Access,
         "FUNC-OSC-014: Tmux wrap ends with ESC \\");
      Register_Routine (T, Test_Wrap_Tmux_Inner_Esc'Access,
         "FUNC-OSC-014: Tmux wrap contains inner ESC before query bytes");
      Register_Routine (T, Test_Wrap_Tmux_Empty_Query'Access,
         "FUNC-OSC-014: Tmux wrap with empty query still has wrapper bytes");
      Register_Routine (T, Test_Wrap_Screen_Has_DCS_Prefix'Access,
         "FUNC-OSC-014: Screen wrap starts with ESC P");
      Register_Routine (T, Test_Wrap_Screen_Has_ST_Suffix'Access,
         "FUNC-OSC-014: Screen wrap ends with ESC \\");
      Register_Routine (T, Test_Wrap_Screen_Length'Access,
         "FUNC-OSC-014: Screen wrap length = 4 + Query'Length");
   end Register_Tests;
   ...
   begin
      Assert
         (not Contains_DA1_Response (Buf, 0),
          "Contains_DA1_Response with Length=0 should return False");
   ...
   is
      ...
      Buf : constant Byte_Array (1 .. 5) :=
         [16#41#, 16#42#, 16#43#, 16#44#, 16#45#];  --  A B C D E
   begin
      Assert
         (not Contains_DA1_Response (Buf, Buf'Length),
          "Contains_DA1_Response with no ESC bytes should return False");
   ...
   is
      ...
      Buf : constant Byte_Array (1 .. 5) :=
         [ESC_BYTE, CSI_L, QUEST, DIG_6, DIG_4];
   begin
      Assert
         (not Contains_DA1_Response (Buf, Buf'Length),
   ...
   is
      ...
      Buf : constant Byte_Array (1 .. 8) :=
         [ESC_BYTE, CSI_L, QUEST, DIG_6, DIG_4, SEMI, DIG_1, TERM_C];
   begin
      Assert
         (Contains_DA1_Response (Buf, Buf'Length),
          "Contains_DA1_Response with ESC [ ? 6 4 ; 1 c should return True");
   ...
   is
      ...
      Buf : constant Byte_Array (1 .. 17) :=
         [ESC_BYTE, 16#5D#,              --  ESC ]
          DIG_1, DIG_1, SEMI,            --  1 1 ;
          16#72#, 16#67#, 16#62#,        --  r g b (stub)
          ESC_BYTE, ST_BACK,             --  ESC \ (ST)
          ESC_BYTE, CSI_L, QUEST,        --  ESC [ ?
          DIG_6, DIG_4, SEMI, TERM_C];   --  6 4 ; c
   begin
      Assert
         (Contains_DA1_Response (Buf, Buf'Length),
   ...
   is
      ...
      Buf : constant Byte_Array (1 .. 4) :=
         [ESC_BYTE, CSI_L, QUEST, TERM_C];
   begin
      Assert
         (Contains_DA1_Response (Buf, Buf'Length),
          "Contains_DA1_Response with minimal ESC [ ? c should return True");
   ...
   is
      ...
      Buf : constant Byte_Array (1 .. 9) :=
         [ESC_BYTE, CSI_L, DIG_6, LOWER_N,  --  ESC [ 6 n  (CPR, not DA1)
          16#41#,                            --  some other byte
          ESC_BYTE, CSI_L, QUEST, TERM_C];   --  ESC [ ? c  (DA1)
   begin
      Assert
         (Contains_DA1_Response (Buf, Buf'Length),
   ...
   begin
      Assert
         (Result = 0,
          "DA1_Response_Start with Length=0 should return 0 (= Length),"
          & " got" & Natural'Image (Result));
   ...
   is
      ...
      Buf    : constant Byte_Array (1 .. 6) :=
         [ESC_BYTE, CSI_L, QUEST, DIG_6, DIG_4, TERM_C];
      Result : constant Natural := DA1_Response_Start (Buf, Buf'Length);
   begin
      Assert
         (Result = 1,
          "DA1_Response_Start with DA1 at byte 1 should return 1,"
          & " got" & Natural'Image (Result));
   ...
   is
      ...
      Buf    : constant Byte_Array (1 .. 8) :=
         [16#41#, 16#42#, 16#43#,             --  A B C
          ESC_BYTE, CSI_L, QUEST, DIG_1, TERM_C];
      Result : constant Natural := DA1_Response_Start (Buf, Buf'Length);
   begin
      Assert
         (Result = 4,
          "DA1_Response_Start with 3 prefix bytes should return 4 (ESC position),"
          & " got" & Natural'Image (Result));
   ...
   begin
      ...
      Assert
         (Result = 11,
          "DA1_Response_Start after OSC 11 response should return 11,"
          & " got" & Natural'Image (Result));
   ...
   is
      ...
      Buf_With    : constant Byte_Array (1 .. 4) :=
         [ESC_BYTE, CSI_L, QUEST, TERM_C];
      Buf_Without : constant Byte_Array (1 .. 3) :=
         [16#41#, 16#42#, 16#43#];
   ...
   begin
      Assert
         (R1 <= Buf_With'Length,
          "DA1_Response_Start postcondition: result <= Length violated (found case),"
          & " result=" & Natural'Image (R1));
      Assert
         (R2 <= Buf_Without'Length,
          "DA1_Response_Start postcondition: result <= Length violated (not-found case),"
          & " result=" & Natural'Image (R2));
   ...
   begin
      Assert
         (Result.Count = 0,
          "Parse_DA1_Response with Length=0 should return Count=0,"
          & " got" & Natural'Image (Result.Count));
   ...
   begin
      Assert
         (Result.Count = 2,
          "Parse_DA1_Response ESC [ ? 6 4 ; 1 c should return Count=2,"
          & " got" & Natural'Image (Result.Count));
      Assert
         (Result.Values (1) = 64,
          "Parse_DA1_Response first param should be 64,"
          & " got" & Natural'Image (Result.Values (1)));
      Assert
         (Result.Values (2) = 1,
          "Parse_DA1_Response second param should be 1,"
          & " got" & Natural'Image (Result.Values (2)));
   ...
   is
      ...
      --  ESC [ ? 6 c
      Buf    : constant Byte_Array (1 .. 5) :=
         [ESC_BYTE, CSI_L, QUEST, DIG_6, TERM_C];
      Result : constant DA1_Params := Parse_DA1_Response (Buf, Buf'Length);
   begin
      Assert
         (Result.Count = 1,
          "Parse_DA1_Response ESC [ ? 6 c should return Count=1,"
          & " got" & Natural'Image (Result.Count));
      Assert
         (Result.Values (1) = 6,
          "Parse_DA1_Response single param should be 6,"
          & " got" & Natural'Image (Result.Values (1)));
   ...
   is
      ...
      Buf    : constant Byte_Array (1 .. 13) :=
         [ESC_BYTE, CSI_L, QUEST,
          DIG_1, SEMI, DIG_2, SEMI, DIG_4, SEMI, DIG_6, SEMI, DIG_9,
          TERM_C];
      Result : constant DA1_Params := Parse_DA1_Response (Buf, Buf'Length);
   begin
      Assert
         (Result.Count = 5,
          "Parse_DA1_Response with 5 params should return Count=5,"
          & " got" & Natural'Image (Result.Count));
      Assert
         (Result.Values (1) = 1,
          "Parse_DA1_Response param 1 should be 1,"
          & " got" & Natural'Image (Result.Values (1)));
      Assert
         (Result.Values (3) = 4,
          "Parse_DA1_Response param 3 should be 4,"
          & " got" & Natural'Image (Result.Values (3)));
      Assert
         (Result.Values (5) = 9,
          "Parse_DA1_Response param 5 should be 9,"
          & " got" & Natural'Image (Result.Values (5)));
   ...
   begin
      Assert
         (Result.Count = 0,
          "Parse_DA1_Response with no DA1 pattern should return Count=0,"
          & " got" & Natural'Image (Result.Count));
   ...
   begin
      Assert
         (Result.Count = 0,
          "Parse_DA1_Response without terminating c should return Count=0,"
          & " got" & Natural'Image (Result.Count));
   ...
   begin
      Assert
         (Result.Count = 0,
          "Parse_DA1_Response with wrong prefix (no ?) should return Count=0,"
          & " got" & Natural'Image (Result.Count));
   ...
   begin
      Assert
         (Result.Count <= MAX_DA1_PARAMS,
          ...
          & " Count=" & Natural'Image (Result.Count)
          & " MAX_DA1_PARAMS=" & Natural'Image (MAX_DA1_PARAMS));
   ...
   begin
      Assert
         (Result.Count = 2,
          "Parse_DA1_Response with multi-digit params should return Count=2,"
          & " got" & Natural'Image (Result.Count));
      Assert
         (Result.Values (1) = 15,
          "Parse_DA1_Response first multi-digit param should be 15,"
          & " got" & Natural'Image (Result.Values (1)));
      Assert
         (Result.Values (2) = 22,
          "Parse_DA1_Response second multi-digit param should be 22,"
          & " got" & Natural'Image (Result.Values (2)));
   ...
   begin
      Assert
         (Result'Length = Query'Length,
          ...
          & " expected" & Natural'Image (Query'Length)
          & " got" & Natural'Image (Result'Length));
      for I in Query'Range loop
         Assert
            (Result (Result'First + (I - Query'First)) = Query (I),
             "Wrap_For_Passthrough No_Passthrough should preserve byte at index"
             & Positive'Image (I));
      end loop;
   ...
   begin
      Assert
         (Result'Length = 0,
          ...
          & " got length" & Natural'Image (Result'Length));
   ...
   begin
      Assert
         (Result'Length >= 7,
          ...
          & " got" & Natural'Image (Result'Length));
      Assert
         (Result (Result'First) = ESC_BYTE,
          "Wrap_For_Passthrough Tmux: byte 1 should be ESC (0x1B)");
      Assert
         (Result (Result'First + 1) = DCS_P,
          "Wrap_For_Passthrough Tmux: byte 2 should be P (0x50, DCS introducer)");
      --  Bytes 3-7 should spell "tmux;"
      Assert
         (Result (Result'First + 2) = CHR_T,
          "Wrap_For_Passthrough Tmux: byte 3 should be 't'");
      Assert
         (Result (Result'First + 3) = CHR_M,
          "Wrap_For_Passthrough Tmux: byte 4 should be 'm'");
      Assert
         (Result (Result'First + 4) = CHR_U,
          "Wrap_For_Passthrough Tmux: byte 5 should be 'u'");
      Assert
         (Result (Result'First + 5) = CHR_X,
          "Wrap_For_Passthrough Tmux: byte 6 should be 'x'");
      Assert
         (Result (Result'First + 6) = SEMI,
          "Wrap_For_Passthrough Tmux: byte 7 should be ';'");
   ...
   begin
      Assert
         (Result'Length >= 2,
          "Wrap_For_Passthrough Tmux result must have at least 2 bytes for ST suffix");
      Assert
         (Result (Result'Last - 1) = ESC_BYTE,
          "Wrap_For_Passthrough Tmux: penultimate byte should be ESC (ST start)");
      Assert
         (Result (Result'Last) = ST_BACK,
          "Wrap_For_Passthrough Tmux: last byte should be \\ (0x5C, ST end)");
   ...
   begin
      Assert
         (Result'Length >= 8,
          ...
          & " got" & Natural'Image (Result'Length));
      Assert
         (Result (Result'First + 7) = ESC_BYTE,
          "Wrap_For_Passthrough Tmux: byte 8 should be inner ESC before query");
   ...
   begin
      Assert
         (Result'Length > 0,
          "Wrap_For_Passthrough Tmux with empty query should still have wrapper bytes,"
          & " got length 0");
      Assert
         (Result (Result'First) = ESC_BYTE,
          "Wrap_For_Passthrough Tmux empty: first byte should be ESC");
      Assert
         (Result (Result'Last) = ST_BACK,
          "Wrap_For_Passthrough Tmux empty: last byte should be \\ (ST end)");
   ...
   begin
      Assert
         (Result'Length >= 2,
          "Wrap_For_Passthrough Screen result must have at least 2 bytes for DCS prefix");
      Assert
         (Result (Result'First) = ESC_BYTE,
          "Wrap_For_Passthrough Screen: byte 1 should be ESC");
      Assert
         (Result (Result'First + 1) = DCS_P,
          "Wrap_For_Passthrough Screen: byte 2 should be P (0x50, DCS introducer)");
   ...
   begin
      Assert
         (Result'Length >= 2,
          "Wrap_For_Passthrough Screen result must have at least 2 bytes for ST suffix");
      Assert
         (Result (Result'Last - 1) = ESC_BYTE,
          "Wrap_For_Passthrough Screen: penultimate byte should be ESC (ST start)");
      Assert
         (Result (Result'Last) = ST_BACK,
          "Wrap_For_Passthrough Screen: last byte should be \\ (0x5C, ST end)");
