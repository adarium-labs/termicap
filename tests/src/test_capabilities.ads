...
package Test_Capabilities is
   ...
   procedure Test_Downsampling_True_Color (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-012): Extended_256 => Downsampling_Available = True
   procedure Test_Downsampling_Extended_256 (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-012): Basic_16 => Downsampling_Available = False
   procedure Test_Downsampling_Basic_16 (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-012): None => Downsampling_Available = False
   procedure Test_Downsampling_None (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Fields_TTY_Stdin (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-001): TTY_Stdout field matches parameter
   procedure Test_Fields_TTY_Stdout (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-001): TTY_Stderr field matches parameter
   procedure Test_Fields_TTY_Stderr (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-001): Color field matches parameter
   procedure Test_Fields_Color (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-001): Size field matches parameter
   procedure Test_Fields_Size (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-001): Unicode field matches parameter
   procedure Test_Fields_Unicode (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-001): Identity.Kind field matches parameter
   procedure Test_Fields_Identity_Kind (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Different_Tty_Stdout_Different_Color (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Assemble_Stream_Agnostic (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Override_Force_True_Color (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-006): Set_Override (Force_None) -> Detect.Color = None
   procedure Test_Override_Force_None (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-006): Set_Override (Force_Basic) -> Detect.Color = Basic_16
   procedure Test_Override_Force_Basic (T : in out AUnit.Test_Cases.Test_Case'Class);

   --  @relation(FUNC-CAP-006): Set_Override (Force_256) -> Detect.Color = Extended_256
   procedure Test_Override_Force_256 (T : in out AUnit.Test_Cases.Test_Case'Class);
   ...
   procedure Test_Redetection_Produces_Independent_Records (T : in out AUnit.Test_Cases.Test_Case'Class);
